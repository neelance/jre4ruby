      ...
      const_set_lazy(:Decoder) { Class.new(IBM943::Decoder) do
        ...
        class_module.module_eval {
          when_class_loaded do
            ...
            const_set :SingleByteToChar, indexs + (IBM943::Decoder.attr_single_byte_to_char.substring(indexs.length)).to_s
          end
        }
      ...
      const_set_lazy(:Encoder) { Class.new(IBM943::Encoder) do
        ...
        class_module.module_eval {
          ...
          when_class_loaded do
            ...
            const_set :Index2a, (IBM943::Encoder.attr_index2a).to_s + indexs
