    ...
    class_module.module_eval {
        ...
        AccessController.do_privileged(Class.new(PrivilegedAction.class == Class ? PrivilegedAction : Object) do
          ...
          define_method :run do
            begin
              ...
              ctor = cl.get_declared_constructor(Array.typed(Class).new([Array, Array, Runnable.class]))
      ...
      def at_bug_level(bl)
        ...
        if ((self.attr_bug_level).nil?)
          ...
          self.attr_bug_level = ((!(value).nil?) ? value : "").to_s
        end
