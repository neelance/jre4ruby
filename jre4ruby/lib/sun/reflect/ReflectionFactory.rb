...
# have any questions.
module Sun::Reflect
  module ReflectionFactoryImports
      ...
      def check_initted
        ...
        AccessController.do_privileged(Class.new(PrivilegedAction.class == Class ? PrivilegedAction : Object) do
          ...
          define_method :run do
            ...
            val = (System.get_property("sun.reflect.inflationThreshold")).to_s
            if (!(val).nil?)
              begin
