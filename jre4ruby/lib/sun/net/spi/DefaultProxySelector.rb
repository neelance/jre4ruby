          ...
          while i < Props.attr_length
            if (Props[i][0].equals_ignore_case(proto))
              ...
              while j < Props[i].attr_length
                ...
                # property.
                phost = (NetProperties.get((Props[i][j]).to_s + "Host")).to_s
              ...
              if (!(nprop).nil?)
                nphosts = (NetProperties.get(nprop.attr_property)).to_s
              ...
              pport = NetProperties.get_integer((Props[i][j]).to_s + "Port", 0).int_value
