...
module Sun::Net::Httpserver
  ...
  class Event 
    ...
    alias_method :attr_exchange, :exchange
    undef_method :exchange
    alias_method :attr_exchange=, :exchange=
    undef_method :exchange=
  ...
  class WriteFinishedEvent < EventImports.const_get :Event
    include_class_members EventImports
    ...
    private
    alias_method :initialize__write_finished_event, :initialize
  end
