...
module Sun::Net::Www::Protocol::Http
  module AuthenticationHeaderImports
  ...
  class AuthenticationHeader 
    ...
    class_module.module_eval {
      when_class_loaded do
        self.attr_auth_pref = (Java::Security::AccessController.do_privileged(Sun::Security::Action::GetPropertyAction.new("http.auth.preference"))).to_s
        ...
        if (!(self.attr_auth_pref).nil?)
          self.attr_auth_pref = (self.attr_auth_pref.to_lower_case).to_s
