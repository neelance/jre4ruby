    ...
    class_module.module_eval {
      ...
      def release_loader(class_loader, jars_closed)
        ...
        begin
          ...
          System.out.println("classLoader = " + (class_loader).to_s)
          System.out.println("SharedSecrets.getJavaNetAccess()=" + (SharedSecrets.get_java_net_access).to_s)
