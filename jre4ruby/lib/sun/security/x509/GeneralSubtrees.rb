    ...
    def create_widest_subtree(name)
      begin
        ...
        when GeneralNameInterface::NAME_OID
          ...
          raise IOException.new("Unsupported GeneralNameInterface type: " + (name.get_type).to_s)
        end
        return GeneralSubtree.new(new_name, 0, -1)
      rescue IOException => e
        raise RuntimeException.new("Unexpected error: " + (e).to_s, e)
      end
    end
