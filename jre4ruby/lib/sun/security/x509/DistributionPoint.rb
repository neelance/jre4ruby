...
module Sun::Security::X509
  ...
  class DistributionPoint 
    ...
    def equals(obj)
      ...
      other = obj
      equal = equals(@full_name, other.attr_full_name) && equals(@relative_name, other.attr_relative_name) && equals(@crl_issuer, other.attr_crl_issuer) && (Arrays == @reason_flags)
      return equal
    end
    ...
    class_module.module_eval {
      ...
      def reason_to_string(reason)
        ...
        return "Unknown reason " + (reason).to_s
      end
    }
    ...
    def to_s
      ...
      if (!(@crl_issuer).nil?)
        sb.append("   CRLIssuer:" + (@crl_issuer).to_s + "\n")
      end
      return sb.to_s
    end
