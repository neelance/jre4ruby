      ...
      when_class_loaded do
        ...
        if ((egd_source == URL_DEV_RANDOM) || (egd_source == URL_DEV_URANDOM))
          begin
            ...
            if (!(Debug).nil?)
              Debug.println("Failed to use operating system seed " + "generator: " + (e.to_s).to_s)
            end
          end
        else
    ...
    class_module.module_eval {
      ...
      const_set_lazy(:URLSeedGenerator) { Class.new(SeedGenerator) do
        ...
        def init
          ...
          if ((@dev_random).nil?)
            raise IOException.new("failed to open " + (device).to_s)
          end
        end
        ...
        def get_seed_byte
          ...
          begin
            ...
            raise InternalError.new("URLSeedGenerator " + @device_name + " generated exception: " + (ioe.get_message).to_s)
          end
