...
module Sun::Security::Provider::Certpath
  ...
  class ReverseState 
    ...
    def to_s
      ...
      begin
        sb.append("State [")
        sb.append("\n  subjectDN of last cert: " + (@subject_dn).to_s)
        sb.append("\n  subjectKeyIdentifier: " + (String.value_of(@subj_key_id)).to_s)
        sb.append("\n  nameConstraints: " + (String.value_of(@nc)).to_s)
        sb.append("\n  certIndex: " + (@cert_index).to_s)
        sb.append("\n  explicitPolicy: " + (@explicit_policy).to_s)
        sb.append("\n  policyMapping:  " + (@policy_mapping).to_s)
        sb.append("\n  inhibitAnyPolicy:  " + (@inhibit_any_policy).to_s)
        sb.append("\n  rootNode: " + (@root_node).to_s)
        sb.append("\n  remainingCACerts: " + (@remaining_cacerts).to_s)
        sb.append("\n  crlSign: " + (@crl_sign).to_s)
        sb.append("\n  init: " + (@init).to_s)
        sb.append("\n]\n")
      rescue Exception => e
        if (!(Debug).nil?)
