  ...
  class CertId 
    ...
    def initialize(issuer_cert, serial_number)
      ...
      if (Debug)
        ...
        System.out.println("Issuer Certificate is " + (issuer_cert).to_s)
        System.out.println("issuerNameHash is " + (encoder.encode(@issuer_name_hash)).to_s)
        System.out.println("issuerKeyHash is " + (encoder.encode(@issuer_key_hash)).to_s)
      end
    end
    ...
    def encode(out)
      ...
      if (Debug)
        encoder = HexDumpEncoder.new
        System.out.println("Encoded certId is " + (encoder.encode(out.to_byte_array)).to_s)
      end
    end
