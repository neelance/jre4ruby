  ...
  class ForwardBuilder < ForwardBuilderImports.const_get :Builder
    ...
    def get_matching_cacerts(current_state, cert_stores, ca_certs)
      ...
      if (!(Debug).nil?)
        ...
        Debug.println("ForwardBuilder.getMatchingCACerts: found " + (num_certs).to_s + " CA certs")
      end
    end
    ...
    class_module.module_eval {
      ...
      const_set_lazy(:PKIXCertComparator) { Class.new do
        ...
        def compare(o_cert1, o_cert2)
          ...
          if (!(Debug).nil?)
            Debug.println(self.class::METHOD_NME + " o1 Issuer:  " + (c_issuer1).to_s)
            Debug.println(self.class::METHOD_NME + " o2 Issuer:  " + (c_issuer2).to_s)
          end
          ...
          if (!(Debug).nil?)
            Debug.println(self.class::METHOD_NME + " m1: " + (m1).to_s)
            Debug.println(self.class::METHOD_NME + " m2: " + (m2).to_s)
          end
          if (m1 && m2)
            return -1
          else
          ...
          if (!(Debug).nil?)
            Debug.println(self.class::METHOD_NME + " o1 Subject: " + (c_subject1).to_s)
            Debug.println(self.class::METHOD_NME + " o2 Subject: " + (c_subject2).to_s)
          end
          ...
          if (!(Debug).nil?)
            Debug.println(self.class::METHOD_NME + " distanceStoI1: " + (distance_sto_i1).to_s)
            Debug.println(self.class::METHOD_NME + " distanceStoI2: " + (distance_sto_i2).to_s)
          end
    ...
    def verify_cert(cert, current_state, cert_path_list)
      ...
      if (!(cert_path_list).nil?)
        ...
        cert_path_list.each do |cpListCert|
          ...
          if (!(Debug).nil?)
            Debug.println("policyMappingFound = " + (policy_mapping_found).to_s)
          end
