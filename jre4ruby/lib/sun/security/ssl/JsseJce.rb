  ...
  class JsseJce 
    ...
    class_module.module_eval {
      ...
      def get_secure_random
        ...
        raise KeyManagementException.new("FIPS mode: no SecureRandom " + " implementation found in provider " + (self.attr_crypto_provider.get_name).to_s)
      end
      ...
      def get_rsapublic_key_spec(key)
        ...
        begin
          ...
          return factory.get_key_spec(key, RSAPublicKeySpec.class)
        rescue Exception => e
