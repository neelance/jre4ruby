  ...
  class Debug 
    ...
    class_module.module_eval {
      ...
      when_class_loaded do
        self.attr_args = (Java::Security::AccessController.do_privileged(GetPropertyAction.new("javax.net.debug", ""))).to_s
        self.attr_args = (self.attr_args.to_lower_case).to_s
      ...
      def is_on(option)
        if ((self.attr_args).nil?)
          ...
          n = 0
          option = (option.to_lower_case).to_s
