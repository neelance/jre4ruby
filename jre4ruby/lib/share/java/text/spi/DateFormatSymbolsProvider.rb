...
module Java::Text::Spi
  module DateFormatSymbolsProviderImports #:nodoc:
  ...
  # 
  # @since        1.6
  class DateFormatSymbolsProvider < DateFormatSymbolsProviderImports.const_get :LocaleServiceProvider
    include_class_members DateFormatSymbolsProviderImports
    ...
    private
    alias_method :initialize__date_format_symbols_provider, :initialize
  end
