...
module Java::Text::Spi
  module DecimalFormatSymbolsProviderImports #:nodoc:
  ...
  # 
  # @since        1.6
  class DecimalFormatSymbolsProvider < DecimalFormatSymbolsProviderImports.const_get :LocaleServiceProvider
    ...
    private
    alias_method :initialize__decimal_format_symbols_provider, :initialize
  end
