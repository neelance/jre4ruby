...
module Java::Text
  ...
  class Normalizer 
    ...
    class_module.module_eval {
      const_set_lazy(:NFD) { Form::NFD }
      const_attr_reader  :NFD
      
      const_set_lazy(:NFC) { Form::NFC }
      const_attr_reader  :NFC
      
      const_set_lazy(:NFKD) { Form::NFKD }
      ...
      # is null.
      def normalize(src, form)
        return NormalizerBase.normalize(src.to_s, form)
      end
      ...
      # @throws NullPointerException If <code>src</code> or <code>form</code>
      # is null.
      def is_normalized(src, form)
        return NormalizerBase.is_normalized(src.to_s, form)
      end
    }
