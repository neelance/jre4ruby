  ...
  class UUID 
    ...
    class_module.module_eval {
      ...
      def from_string(name)
        ...
        i = 0
        while i < 5
          components[i] = "0x" + RJava.cast_to_string(components[i])
          i += 1
        end
    ...
    def to_s
      return (RJava.cast_to_string(digits(@most_sig_bits >> 32, 8)) + "-" + RJava.cast_to_string(digits(@most_sig_bits >> 16, 4)) + "-" + RJava.cast_to_string(digits(@most_sig_bits, 4)) + "-" + RJava.cast_to_string(digits(@least_sig_bits >> 48, 4)) + "-" + RJava.cast_to_string(digits(@least_sig_bits, 12)))
    end
