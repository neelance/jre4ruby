...
module Java::Util::Concurrent
  module ExecutionExceptionImports
  ...
  # @since 1.5
  # @author Doug Lea
  class ExecutionException < ExecutionExceptionImports.const_get :JavaException
    include_class_members ExecutionExceptionImports
    
    class_module.module_eval {
      const_set_lazy(:SerialVersionUID) { 7830266012832686185 }
