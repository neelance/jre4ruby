...
module Java::Util::Concurrent::Locks
  module AbstractQueuedLongSynchronizerImports
  ...
  # @since 1.6
  # @author Doug Lea
  class AbstractQueuedLongSynchronizer < AbstractQueuedLongSynchronizerImports.const_get :AbstractOwnableSynchronizer
    include_class_members AbstractQueuedLongSynchronizerImports
    overload_protected {
      include Java::Io::Serializable
    }
    
    class_module.module_eval {
      const_set_lazy(:SerialVersionUID) { 7373984972572414692 }
    ...
    def compare_and_set_state(expect, update)
      ...
      return Unsafe.compare_and_swap_long(self, StateOffset, expect, update)
    end
    ...
    def to_s
      ...
      return RJava.cast_to_string(super) + "[State = " + RJava.cast_to_string(s) + ", " + q + "empty queue]"
    end
    ...
    class_module.module_eval {
      ...
      when_class_loaded do
        begin
          const_set :StateOffset, Unsafe.object_field_offset(AbstractQueuedLongSynchronizer.get_declared_field("state"))
          const_set :HeadOffset, Unsafe.object_field_offset(AbstractQueuedLongSynchronizer.get_declared_field("head"))
          const_set :TailOffset, Unsafe.object_field_offset(AbstractQueuedLongSynchronizer.get_declared_field("tail"))
    ...
    private
    alias_method :initialize__abstract_queued_long_synchronizer, :initialize
  end
