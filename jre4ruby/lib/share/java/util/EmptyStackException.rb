...
# have any questions.
module Java::Util
  module EmptyStackExceptionImports #:nodoc:
  ...
  # @see     java.util.Stack
  # @since   JDK1.0
  class EmptyStackException < EmptyStackExceptionImports.const_get :RuntimeException
    ...
    private
    alias_method :initialize__empty_stack_exception, :initialize
  end
