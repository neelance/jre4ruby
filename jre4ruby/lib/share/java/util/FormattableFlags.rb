...
# have any questions.
module Java::Util
  module FormattableFlagsImports #:nodoc:
  ...
  class FormattableFlags 
    include_class_members FormattableFlagsImports
    ...
    class_module.module_eval {
      ...
      const_set_lazy(:LEFT_JUSTIFY) { 1 << 0 }
      ...
      # the format specifier.
      const_set_lazy(:ALTERNATE) { 1 << 2 }
      const_attr_reader  :ALTERNATE
    }
    
    private
    alias_method :initialize__formattable_flags, :initialize
  end
