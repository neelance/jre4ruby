...
module Java::Util::Zip
  ...
  class CRC32 
    ...
    class_module.module_eval {
      JNI.load_native_method :Java_java_util_zip_CRC32_update, [:pointer, :long, :int32, :int32], :int32
      typesig { [::Java::Int, ::Java::Int] }
      def update(crc, b)
        JNI.call_native_method(:Java_java_util_zip_CRC32_update, JNI.env, self.jni_id, crc.to_int, b.to_int)
      end
      
      JNI.load_native_method :Java_java_util_zip_CRC32_updateBytes, [:pointer, :long, :int32, :long, :int32, :int32], :int32
      typesig { [::Java::Int, Array.typed(::Java::Byte), ::Java::Int, ::Java::Int] }
      def update_bytes(crc, b, off, len)
        JNI.call_native_method(:Java_java_util_zip_CRC32_updateBytes, JNI.env, self.jni_id, crc.to_int, b.jni_id, off.to_int, len.to_int)
      end
    }
