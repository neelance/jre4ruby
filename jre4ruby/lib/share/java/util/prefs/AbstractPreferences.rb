...
module Java::Util::Prefs
  module AbstractPreferencesImports #:nodoc:
  ...
  class AbstractPreferences < AbstractPreferencesImports.const_get :Preferences
    ...
    def initialize(parent, name)
      ...
      if ((parent).nil?)
        ...
        @absolute_path = RJava.cast_to_string(((parent).equal?(@root) ? "/" + name : RJava.cast_to_string(parent.absolute_path) + "/" + name))
      end
      @name = name
      @parent = parent
    end
    ...
    def get(key, def_)
      ...
      synchronized((@lock)) do
        ...
        result = nil
        begin
          result = RJava.cast_to_string(get_spi(key))
    ...
    def to_s
      return RJava.cast_to_string((self.is_user_node ? "User" : "System")) + " Preference Node: " + RJava.cast_to_string(self.absolute_path)
    end
