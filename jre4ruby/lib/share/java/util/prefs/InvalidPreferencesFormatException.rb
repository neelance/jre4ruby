...
module Java::Util::Prefs
  module InvalidPreferencesFormatExceptionImports #:nodoc:
  ...
  # @see     Preferences
  # @since   1.4
  class InvalidPreferencesFormatException < InvalidPreferencesFormatExceptionImports.const_get :JavaException
