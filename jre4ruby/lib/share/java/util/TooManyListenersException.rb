...
# have any questions.
module Java::Util
  module TooManyListenersExceptionImports #:nodoc:
  ...
  # @since  JDK1.1
  class TooManyListenersException < TooManyListenersExceptionImports.const_get :JavaException
    ...
    private
    alias_method :initialize__too_many_listeners_exception, :initialize
  end
