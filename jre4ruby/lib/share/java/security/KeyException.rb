...
module Java::Security
  module KeyExceptionImports #:nodoc:
  ...
  class KeyException < KeyExceptionImports.const_get :GeneralSecurityException
    include_class_members KeyExceptionImports
    
    class_module.module_eval {
      const_set_lazy(:SerialVersionUID) { -7483676942812432108 }
    ...
    private
    alias_method :initialize__key_exception, :initialize
  end
