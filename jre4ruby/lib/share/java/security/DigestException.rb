...
module Java::Security
  module DigestExceptionImports #:nodoc:
  ...
  class DigestException < DigestExceptionImports.const_get :GeneralSecurityException
    include_class_members DigestExceptionImports
    
    class_module.module_eval {
      const_set_lazy(:SerialVersionUID) { 5821450303093652515 }
    ...
    private
    alias_method :initialize__digest_exception, :initialize
  end
