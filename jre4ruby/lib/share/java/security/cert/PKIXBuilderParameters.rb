...
module Java::Security::Cert
  module PKIXBuilderParametersImports #:nodoc:
  ...
  # @since       1.4
  # @author      Sean Mullan
  class PKIXBuilderParameters < PKIXBuilderParametersImports.const_get :PKIXParameters
    include_class_members PKIXBuilderParametersImports
    ...
    def initialize(trust_anchors, target_constraints)
      ...
      super(trust_anchors)
      @max_path_length = 5
      set_target_cert_constraints(target_constraints)
    end
    ...
    def set_max_path_length(max_path_length)
      if (max_path_length < -1)
        raise InvalidParameterException.new("the maximum path " + "length parameter can not be less than -1")
      end
    ...
    def to_s
      ...
      sb.append("[\n")
      sb.append(super)
      sb.append("  Maximum Path Length: " + RJava.cast_to_string(@max_path_length) + "\n")
      sb.append("]\n")
      return sb.to_s
    end
    
    private
    alias_method :initialize__pkixbuilder_parameters, :initialize
  end
