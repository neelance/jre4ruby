...
module Java::Security::Cert
  module CertPathBuilderImports #:nodoc:
  ...
  class CertPathBuilder 
    ...
    class_module.module_eval {
      ...
      def get_instance(algorithm)
        instance = GetInstance.get_instance("CertPathBuilder", CertPathBuilderSpi, algorithm)
      ...
      def get_instance(algorithm, provider)
        instance = GetInstance.get_instance("CertPathBuilder", CertPathBuilderSpi, algorithm, provider)
        return CertPathBuilder.new(instance.attr_impl, instance.attr_provider, algorithm)
      end
