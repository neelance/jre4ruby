...
module Java::Security::Cert
  ...
  class CertPath 
    ...
    def to_s
      ...
      sb.append("\n" + @type + " Cert Path: length = " + RJava.cast_to_string(get_certificates.size) + ".\n")
      sb.append("[\n")
      i = 1
      while (string_iterator.has_next)
        sb.append("==========================================" + "===============Certificate " + RJava.cast_to_string(i) + " start.\n")
        string_cert = string_iterator.next_
        sb.append(string_cert.to_s)
        sb.append("\n========================================" + "=================Certificate " + RJava.cast_to_string(i) + " end.\n\n\n")
        i += 1
      end
      sb.append("\n]")
      return sb.to_s
