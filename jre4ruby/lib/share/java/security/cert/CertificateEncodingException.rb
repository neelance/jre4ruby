...
module Java::Security::Cert
  module CertificateEncodingExceptionImports #:nodoc:
  ...
  class CertificateEncodingException < CertificateEncodingExceptionImports.const_get :CertificateException
    include_class_members CertificateEncodingExceptionImports
    
    class_module.module_eval {
      const_set_lazy(:SerialVersionUID) { 6219492851589449162 }
    ...
    private
    alias_method :initialize__certificate_encoding_exception, :initialize
  end
