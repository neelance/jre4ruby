...
module Java::Security::Cert
  module CertPathValidatorImports #:nodoc:
  ...
  class CertPathValidator 
    ...
    class_module.module_eval {
      ...
      def get_instance(algorithm)
        instance = GetInstance.get_instance("CertPathValidator", CertPathValidatorSpi, algorithm)
      ...
      def get_instance(algorithm, provider)
        instance = GetInstance.get_instance("CertPathValidator", CertPathValidatorSpi, algorithm, provider)
        return CertPathValidator.new(instance.attr_impl, instance.attr_provider, algorithm)
      end
