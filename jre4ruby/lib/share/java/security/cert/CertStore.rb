  ...
  class CertStore 
    ...
    class_module.module_eval {
      ...
      def get_instance(type, params)
        begin
          instance = GetInstance.get_instance("CertStore", CertStoreSpi, type, params)
      ...
      def get_instance(type, params, provider)
        begin
          instance = GetInstance.get_instance("CertStore", CertStoreSpi, type, params, provider)
          return CertStore.new(instance.attr_impl, instance.attr_provider, type, params)
        rescue NoSuchAlgorithmException => e
          return handle_exception(e)
        end
