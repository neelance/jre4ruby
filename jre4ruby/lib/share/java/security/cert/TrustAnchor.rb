...
module Java::Security::Cert
  module TrustAnchorImports #:nodoc:
  ...
  class TrustAnchor 
    ...
    def to_s
      ...
      sb.append("[\n")
      if (!(@pub_key).nil?)
        sb.append("  Trusted CA Public Key: " + RJava.cast_to_string(@pub_key.to_s) + "\n")
        sb.append("  Trusted CA Issuer Name: " + RJava.cast_to_string(String.value_of(@ca_name)) + "\n")
      else
        sb.append("  Trusted CA cert: " + RJava.cast_to_string(@trusted_cert.to_s) + "\n")
      end
      if (!(@nc).nil?)
        sb.append("  Name Constraints: " + RJava.cast_to_string(@nc.to_s) + "\n")
      end
      return sb.to_s
    end
