...
module Java::Security::Cert
  module CertificateFactorySpiImports #:nodoc:
  ...
  class CertificateFactorySpi 
    ...
    def engine_generate_certificate(in_stream)
    ...
    # 
    # @exception CertificateException on parsing errors.
    def engine_generate_certificates(in_stream)
      raise NotImplementedError
    end
    ...
    def engine_generate_crl(in_stream)
      raise NotImplementedError
    end
    ...
    # 
    # @exception CRLException on parsing errors.
    def engine_generate_crls(in_stream)
      raise NotImplementedError
    end
    ...
    private
    alias_method :initialize__certificate_factory_spi, :initialize
  end
