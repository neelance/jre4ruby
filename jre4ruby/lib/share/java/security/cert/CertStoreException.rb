...
module Java::Security::Cert
  module CertStoreExceptionImports #:nodoc:
  ...
  # @since       1.4
  # @author      Sean Mullan
  class CertStoreException < CertStoreExceptionImports.const_get :GeneralSecurityException
    include_class_members CertStoreExceptionImports
    
    class_module.module_eval {
      const_set_lazy(:SerialVersionUID) { 2395296107471573245 }
    ...
    private
    alias_method :initialize__cert_store_exception, :initialize
  end
