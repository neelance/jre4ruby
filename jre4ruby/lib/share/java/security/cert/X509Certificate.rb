...
module Java::Security::Cert
  module X509CertificateImports #:nodoc:
  ...
  # @see X509Extension
  class X509Certificate < X509CertificateImports.const_get :Certificate
    include_class_members X509CertificateImports
    overload_protected {
      include X509Extension
    }
    
    class_module.module_eval {
      const_set_lazy(:SerialVersionUID) { -2491127588187038216 }
      const_attr_reader  :SerialVersionUID
    }
    
    attr_accessor :subject_x500principal
    alias_method :attr_subject_x500principal, :subject_x500principal
    undef_method :subject_x500principal
    alias_method :attr_subject_x500principal=, :subject_x500principal=
    undef_method :subject_x500principal=
    
    attr_accessor :issuer_x500principal
    alias_method :attr_issuer_x500principal, :issuer_x500principal
    ...
    def get_issuer_x500principal
      if ((@issuer_x500principal).nil?)
        @issuer_x500principal = X509CertImpl.get_issuer_x500principal(self)
      end
      return @issuer_x500principal
    end
    ...
    def get_subject_x500principal
      if ((@subject_x500principal).nil?)
        @subject_x500principal = X509CertImpl.get_subject_x500principal(self)
      end
      return @subject_x500principal
    end
    ...
    def get_extended_key_usage
      return X509CertImpl.get_extended_key_usage(self)
    end
    ...
    def get_subject_alternative_names
      return X509CertImpl.get_subject_alternative_names(self)
    end
    ...
    def get_issuer_alternative_names
      return X509CertImpl.get_issuer_alternative_names(self)
    end
    
    private
    alias_method :initialize__x509certificate, :initialize
  end
