...
module Java::Security
  module NoSuchAlgorithmExceptionImports #:nodoc:
  ...
  class NoSuchAlgorithmException < NoSuchAlgorithmExceptionImports.const_get :GeneralSecurityException
    include_class_members NoSuchAlgorithmExceptionImports
    
    class_module.module_eval {
      const_set_lazy(:SerialVersionUID) { -7443947487218346562 }
    ...
    private
    alias_method :initialize__no_such_algorithm_exception, :initialize
  end
