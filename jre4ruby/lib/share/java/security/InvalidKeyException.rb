...
module Java::Security
  module InvalidKeyExceptionImports #:nodoc:
  ...
  class InvalidKeyException < InvalidKeyExceptionImports.const_get :KeyException
    include_class_members InvalidKeyExceptionImports
    
    class_module.module_eval {
      const_set_lazy(:SerialVersionUID) { 5698479920593359816 }
    ...
    private
    alias_method :initialize__invalid_key_exception, :initialize
  end
