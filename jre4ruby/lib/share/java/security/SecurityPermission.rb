...
module Java::Security
  module SecurityPermissionImports #:nodoc:
  ...
  class SecurityPermission < SecurityPermissionImports.const_get :BasicPermission
    include_class_members SecurityPermissionImports
    
    class_module.module_eval {
      const_set_lazy(:SerialVersionUID) { 5236109936224050470 }
    ...
    private
    alias_method :initialize__security_permission, :initialize
  end
