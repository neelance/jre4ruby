...
module Java::Security
  module KeyStoreExceptionImports #:nodoc:
  ...
  # 
  # @since 1.2
  class KeyStoreException < KeyStoreExceptionImports.const_get :GeneralSecurityException
    include_class_members KeyStoreExceptionImports
    
    class_module.module_eval {
      const_set_lazy(:SerialVersionUID) { -1119353179322377262 }
    ...
    private
    alias_method :initialize__key_store_exception, :initialize
  end
