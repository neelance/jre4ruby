...
# have any questions.
module Java::Io
  module FileWriterImports #:nodoc:
  ...
  # @since       JDK1.1
  class FileWriter < FileWriterImports.const_get :OutputStreamWriter
    ...
    def initialize(fd)
      super(FileOutputStream.new(fd))
    end
    
    private
    alias_method :initialize__file_writer, :initialize
  end
