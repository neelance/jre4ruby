...
# have any questions.
module Java::Io
  module UTFDataFormatExceptionImports #:nodoc:
  ...
  # @since   JDK1.0
  class UTFDataFormatException < UTFDataFormatExceptionImports.const_get :IOException
    ...
    private
    alias_method :initialize__utfdata_format_exception, :initialize
  end
