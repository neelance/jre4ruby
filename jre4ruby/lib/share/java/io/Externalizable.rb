...
# have any questions.
module Java::Io
  module ExternalizableImports #:nodoc:
    class_module.module_eval {
      include ::Java::Lang
      include ::Java::Io
      include_const ::Java::Io, :ObjectOutput
      include_const ::Java::Io, :ObjectInput
    }
  end
  ...
  module Externalizable
    include_class_members ExternalizableImports
