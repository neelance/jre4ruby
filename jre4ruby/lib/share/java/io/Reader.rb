...
module Java::Io
  ...
  # @since       JDK1.1
  class Reader 
    include_class_members ReaderImports
    include Readable
    include Closeable
    ...
    # @exception   IOException  If an I/O error occurs
    def read(cbuf)
      return read(cbuf, 0, cbuf.attr_length)
    end
    ...
    private
    alias_method :initialize__reader, :initialize
  end
