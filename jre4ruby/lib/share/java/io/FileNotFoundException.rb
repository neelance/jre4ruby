...
# have any questions.
module Java::Io
  module FileNotFoundExceptionImports #:nodoc:
  ...
  # @author  unascribed
  # @since   JDK1.0
  class FileNotFoundException < FileNotFoundExceptionImports.const_get :IOException
    ...
    def initialize(path, reason)
      super(path + RJava.cast_to_string((((reason).nil?) ? "" : " (" + reason + ")")))
    end
    
    private
    alias_method :initialize__file_not_found_exception, :initialize
  end
