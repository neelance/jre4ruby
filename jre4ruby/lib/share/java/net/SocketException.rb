...
# have any questions.
module Java::Net
  module SocketExceptionImports #:nodoc:
  ...
  # @since   JDK1.0
  class SocketException < SocketExceptionImports.const_get :IOException
    ...
    private
    alias_method :initialize__socket_exception, :initialize
  end
