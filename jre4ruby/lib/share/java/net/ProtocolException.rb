...
# have any questions.
module Java::Net
  module ProtocolExceptionImports #:nodoc:
  ...
  # @author  Chris Warth
  # @since   JDK1.0
  class ProtocolException < ProtocolExceptionImports.const_get :IOException
    ...
    private
    alias_method :initialize__protocol_exception, :initialize
  end
