...
# have any questions.
module Java::Net
  module URLEncoderImports #:nodoc:
  ...
  class URLEncoder 
    ...
    class_module.module_eval {
      ...
      when_class_loaded do
        ...
        self.attr_dont_need_encoding.set(Character.new(?..ord))
        self.attr_dont_need_encoding.set(Character.new(?*.ord))
        self.attr_dflt_enc_name = RJava.cast_to_string(AccessController.do_privileged(GetPropertyAction.new("file.encoding")))
      end
    }
    ...
    class_module.module_eval {
      ...
      def encode(s)
        str = nil
        begin
          str = RJava.cast_to_string(encode(s, self.attr_dflt_enc_name))
