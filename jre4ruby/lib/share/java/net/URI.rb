...
module Java::Net
  ...
  class URI 
    ...
    def define_scheme_specific_part
      ...
      @scheme_specific_part = RJava.cast_to_string(sb.to_s)
    end
    ...
    def define_string
      ...
      @string = RJava.cast_to_string(sb.to_s)
    end
    ...
    class_module.module_eval {
      ...
      def resolve_path(base, child, absolute)
        ...
        if ((cn).equal?(0))
          # 5.2 (6a)
          if (i >= 0)
            path = RJava.cast_to_string(base.substring(0, i + 1))
          end
        else
          ...
          # 5.2 (6b)
          sb.append(child)
          path = RJava.cast_to_string(sb.to_s)
        end
        # 5.2 (6c-f)
        np = normalize(path)
