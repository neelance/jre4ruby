...
# have any questions.
module Java::Net
  module URLDecoderImports #:nodoc:
  ...
  class URLDecoder 
    ...
    class_module.module_eval {
      ...
      def decode(s)
        str = nil
        begin
          str = RJava.cast_to_string(decode(s, self.attr_dflt_enc_name))
        ...
        while (i < num_chars)
          ...
          when Character.new(?%.ord)
            ...
            begin
              ...
              raise IllegalArgumentException.new("URLDecoder: Illegal hex characters in escape (%) pattern - " + RJava.cast_to_string(e.get_message))
            end
            need_to_change = true
          else
            sb.append(c)
