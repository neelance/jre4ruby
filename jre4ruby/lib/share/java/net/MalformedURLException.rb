...
# have any questions.
module Java::Net
  module MalformedURLExceptionImports #:nodoc:
  ...
  # @since   JDK1.0
  class MalformedURLException < MalformedURLExceptionImports.const_get :IOException
    ...
    private
    alias_method :initialize__malformed_urlexception, :initialize
  end
