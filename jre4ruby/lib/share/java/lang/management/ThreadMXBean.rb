...
module Java::Lang::Management
  module ThreadMXBeanImports #:nodoc:
  ...
  module ThreadMXBean
    ...
    def get_total_started_thread_count
      raise NotImplementedError
    end
    ...
    def is_thread_contention_monitoring_enabled
      raise NotImplementedError
    end
    ...
    # @see #isThreadCpuTimeEnabled
    # @see #setThreadCpuTimeEnabled
    def get_current_thread_user_time
      raise NotImplementedError
    end
    ...
    # @see #isThreadCpuTimeSupported
    # @see #isCurrentThreadCpuTimeSupported
    def is_thread_cpu_time_enabled
      raise NotImplementedError
    end
    ...
    # @see #isThreadCpuTimeSupported
    # @see #isCurrentThreadCpuTimeSupported
    def set_thread_cpu_time_enabled(enable)
      raise NotImplementedError
    end
    ...
    # @see #dumpAllThreads
    # @since 1.6
    def is_object_monitor_usage_supported
      raise NotImplementedError
    end
    ...
    # @see #dumpAllThreads
    # @since 1.6
    def is_synchronizer_usage_supported
      raise NotImplementedError
    end
    ...
    # 
    # @since 1.6
    def get_thread_info(ids, locked_monitors, locked_synchronizers)
      raise NotImplementedError
    end
    ...
    # 
    # @since 1.6
    def dump_all_threads(locked_monitors, locked_synchronizers)
      raise NotImplementedError
    end
  end
