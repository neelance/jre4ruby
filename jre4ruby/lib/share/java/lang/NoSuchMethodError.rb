...
# have any questions.
module Java::Lang
  module NoSuchMethodErrorImports #:nodoc:
  ...
  # @author  unascribed
  # @since   JDK1.0
  class NoSuchMethodError < NoSuchMethodErrorImports.const_get :IncompatibleClassChangeError
    ...
    private
    alias_method :initialize__no_such_method_error, :initialize
  end
