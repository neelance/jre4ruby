...
# have any questions.
module Java::Lang
  module OutOfMemoryErrorImports #:nodoc:
  ...
  # @author  unascribed
  # @since   JDK1.0
  class OutOfMemoryError < OutOfMemoryErrorImports.const_get :VirtualMachineError
    ...
    private
    alias_method :initialize__out_of_memory_error, :initialize
  end
