...
# have any questions.
module Java::Lang
  module ProcessBuilderImports #:nodoc:
  ...
  class ProcessBuilder 
    ...
    def start
      ...
      begin
        ...
        raise IOException.new("Cannot run program \"" + prog + "\"" + RJava.cast_to_string(((dir).nil? ? "" : " (in directory \"" + dir + "\")")) + ": " + RJava.cast_to_string(e.get_message), e)
      end
    end
