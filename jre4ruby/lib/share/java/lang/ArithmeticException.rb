...
# have any questions.
module Java::Lang
  module ArithmeticExceptionImports #:nodoc:
  ...
  # @author  unascribed
  # @since   JDK1.0
  class ArithmeticException < ArithmeticExceptionImports.const_get :RuntimeException
    ...
    private
    alias_method :initialize__arithmetic_exception, :initialize
  end
