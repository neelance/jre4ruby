...
# have any questions.
module Java::Lang
  module TypeNotPresentExceptionImports #:nodoc:
  ...
  # @author  Josh Bloch
  # @since 1.5
  class TypeNotPresentException < TypeNotPresentExceptionImports.const_get :RuntimeException
    include_class_members TypeNotPresentExceptionImports
    ...
    private
    alias_method :initialize__type_not_present_exception, :initialize
  end
