...
module Java::Lang::Annotation
  module AnnotationFormatErrorImports #:nodoc:
  ...
  # @author  Josh Bloch
  # @since   1.5
  class AnnotationFormatError < AnnotationFormatErrorImports.const_get :JavaError
    ...
    private
    alias_method :initialize__annotation_format_error, :initialize
  end
