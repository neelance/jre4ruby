...
# have any questions.
module Java::Lang
  module RuntimePermissionImports #:nodoc:
  ...
  class RuntimePermission < RuntimePermissionImports.const_get :BasicPermission
    include_class_members RuntimePermissionImports
    
    class_module.module_eval {
      const_set_lazy(:SerialVersionUID) { 7399184964622342223 }
    ...
    private
    alias_method :initialize__runtime_permission, :initialize
  end
