...
# have any questions.
module Java::Lang
  module NullPointerExceptionImports #:nodoc:
  ...
  # @author  unascribed
  # @since   JDK1.0
  class NullPointerException < NullPointerExceptionImports.const_get :RuntimeException
    ...
    private
    alias_method :initialize__null_pointer_exception, :initialize
  end
