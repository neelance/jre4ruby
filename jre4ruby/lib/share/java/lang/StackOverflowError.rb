...
# have any questions.
module Java::Lang
  module StackOverflowErrorImports #:nodoc:
  ...
  # @author unascribed
  # @since   JDK1.0
  class StackOverflowError < StackOverflowErrorImports.const_get :VirtualMachineError
    ...
    private
    alias_method :initialize__stack_overflow_error, :initialize
  end
