...
# have any questions.
module Java::Lang
  module CloneNotSupportedExceptionImports #:nodoc:
  ...
  # @since   JDK1.0
  class CloneNotSupportedException < CloneNotSupportedExceptionImports.const_get :JavaException
    ...
    private
    alias_method :initialize__clone_not_supported_exception, :initialize
  end
