...
# have any questions.
module Java::Lang
  module VirtualMachineErrorImports #:nodoc:
  ...
  # @author  Frank Yellin
  # @since   JDK1.0
  class VirtualMachineError < VirtualMachineErrorImports.const_get :JavaError
    ...
    private
    alias_method :initialize__virtual_machine_error, :initialize
  end
