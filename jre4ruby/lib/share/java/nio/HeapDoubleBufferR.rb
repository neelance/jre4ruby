...
module Java::Nio
  module HeapDoubleBufferRImports #:nodoc:
  ...
  class HeapDoubleBufferR < HeapDoubleBufferRImports.const_get :HeapDoubleBuffer
    include_class_members HeapDoubleBufferRImports
    ...
    typesig { [] }
    def slice
      return HeapDoubleBufferR.new(self.attr_hb, -1, 0, self.remaining, self.remaining, self.position + self.attr_offset)
    end
    ...
    private
    alias_method :initialize__heap_double_buffer_r, :initialize
  end
