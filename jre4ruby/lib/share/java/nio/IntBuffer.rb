...
module Java::Nio
  ...
  # @since 1.4
  class IntBuffer < IntBufferImports.const_get :Buffer
    include_class_members IntBufferImports
    overload_protected {
    ...
    typesig { [::Java::Int, ::Java::Int, ::Java::Int, ::Java::Int, Array.typed(::Java::Int), ::Java::Int] }
    ...
    def initialize(mark, pos, lim, cap)
      initialize__int_buffer(mark, pos, lim, cap, nil, 0) # package-private
    end
    ...
    class_module.module_eval {
      ...
      def allocate_(capacity)
        ...
        return HeapIntBuffer.new(capacity, capacity)
      end
      ...
      def wrap(array, offset, length)
        begin
          return HeapIntBuffer.new(array, offset, length)
    ...
    private
    alias_method :initialize__int_buffer, :initialize
  end
