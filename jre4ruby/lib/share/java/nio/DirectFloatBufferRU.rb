...
module Java::Nio
  module DirectFloatBufferRUImports #:nodoc:
  ...
  class DirectFloatBufferRU < DirectFloatBufferRUImports.const_get :DirectFloatBufferU
    include_class_members DirectFloatBufferRUImports
    overload_protected {
    ...
    def slice
      ...
      return DirectFloatBufferRU.new(self, -1, 0, rem, rem, off)
    end
    ...
    private
    alias_method :initialize__direct_float_buffer_ru, :initialize
  end
