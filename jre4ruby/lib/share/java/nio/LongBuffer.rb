...
module Java::Nio
  module LongBufferImports #:nodoc:
  ...
  # @since 1.4
  class LongBuffer < LongBufferImports.const_get :Buffer
    include_class_members LongBufferImports
    overload_protected {
    ...
    typesig { [::Java::Int, ::Java::Int, ::Java::Int, ::Java::Int, Array.typed(::Java::Long), ::Java::Int] }
    ...
    def initialize(mark, pos, lim, cap)
      initialize__long_buffer(mark, pos, lim, cap, nil, 0) # package-private
    end
    ...
    class_module.module_eval {
      ...
      def allocate_(capacity)
        ...
        return HeapLongBuffer.new(capacity, capacity)
      end
      ...
      def wrap(array, offset, length)
        begin
          return HeapLongBuffer.new(array, offset, length)
    ...
    private
    alias_method :initialize__long_buffer, :initialize
  end
