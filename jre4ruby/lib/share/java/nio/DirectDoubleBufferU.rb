...
module Java::Nio
  module DirectDoubleBufferUImports
  ...
  class DirectDoubleBufferU < DirectDoubleBufferUImports.const_get :DoubleBuffer
    ...
    typesig { [] }
    def get
      return ((Unsafe.get_double(ix(next_get_index))))
    end
    
    typesig { [::Java::Int] }
    def get(i)
      return ((Unsafe.get_double(ix(check_index(i)))))
    end
    ...
    typesig { [::Java::Double] }
    def put(x)
      Unsafe.put_double(ix(next_put_index), ((x)))
      return self
    end
    
    typesig { [::Java::Int, ::Java::Double] }
    def put(i, x)
      Unsafe.put_double(ix(check_index(i)), ((x)))
      return self
    end
