...
module Java::Nio
  module ShortBufferImports #:nodoc:
  ...
  # @since 1.4
  class ShortBuffer < ShortBufferImports.const_get :Buffer
    include_class_members ShortBufferImports
    overload_protected {
    ...
    def initialize(mark, pos, lim, cap)
      initialize__short_buffer(mark, pos, lim, cap, nil, 0) # package-private
    end
    ...
    class_module.module_eval {
      ...
      def allocate_(capacity)
        ...
        return HeapShortBuffer.new(capacity, capacity)
      end
      ...
      def wrap(array, offset, length)
        begin
          return HeapShortBuffer.new(array, offset, length)
    ...
    private
    alias_method :initialize__short_buffer, :initialize
  end
