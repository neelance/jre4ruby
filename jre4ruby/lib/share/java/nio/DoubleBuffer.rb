...
module Java::Nio
  module DoubleBufferImports #:nodoc:
  ...
  # @since 1.4
  class DoubleBuffer < DoubleBufferImports.const_get :Buffer
    include_class_members DoubleBufferImports
    overload_protected {
    ...
    typesig { [::Java::Int, ::Java::Int, ::Java::Int, ::Java::Int, Array.typed(::Java::Double), ::Java::Int] }
    ...
    def initialize(mark, pos, lim, cap)
      initialize__double_buffer(mark, pos, lim, cap, nil, 0) # package-private
    end
    ...
    class_module.module_eval {
      ...
      def allocate_(capacity)
        ...
        return HeapDoubleBuffer.new(capacity, capacity)
      end
      ...
      def wrap(array, offset, length)
        begin
          return HeapDoubleBuffer.new(array, offset, length)
    ...
    private
    alias_method :initialize__double_buffer, :initialize
  end
