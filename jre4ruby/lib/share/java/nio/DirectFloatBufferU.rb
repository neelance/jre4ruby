...
module Java::Nio
  ...
  class DirectFloatBufferU < DirectFloatBufferUImports.const_get :FloatBuffer
    ...
    typesig { [] }
    def get
      return ((Unsafe.get_float(ix(next_get_index))))
    end
    
    typesig { [::Java::Int] }
    def get(i)
      return ((Unsafe.get_float(ix(check_index(i)))))
    end
    ...
    typesig { [::Java::Float] }
    def put(x)
      Unsafe.put_float(ix(next_put_index), ((x)))
      return self
    end
    
    typesig { [::Java::Int, ::Java::Float] }
    def put(i, x)
      Unsafe.put_float(ix(check_index(i)), ((x)))
      return self
    end
