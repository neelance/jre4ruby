...
module Java::Nio
  module HeapFloatBufferImports #:nodoc:
  ...
  class HeapFloatBuffer < HeapFloatBufferImports.const_get :FloatBuffer
    include_class_members HeapFloatBufferImports
    ...
    def initialize(cap, lim)
      super(-1, 0, lim, cap, Array.typed(::Java::Float).new(cap) { 0.0 }, 0) # package-private
      # hb = new float[cap];
      # offset = 0;
    end
    ...
    typesig { [Array.typed(::Java::Float), ::Java::Int, ::Java::Int, ::Java::Int, ::Java::Int, ::Java::Int] }
    ...
    typesig { [] }
    def slice
      return HeapFloatBuffer.new(self.attr_hb, -1, 0, self.remaining, self.remaining, self.position + self.attr_offset)
    end
    
    typesig { [] }
    def duplicate
      return HeapFloatBuffer.new(self.attr_hb, self.mark_value, self.position, self.limit, self.capacity, self.attr_offset)
    end
    
    typesig { [] }
    def as_read_only_buffer
      return HeapFloatBufferR.new(self.attr_hb, self.mark_value, self.position, self.limit, self.capacity, self.attr_offset)
    end
    ...
    private
    alias_method :initialize__heap_float_buffer, :initialize
  end
