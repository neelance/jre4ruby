...
module Java::Nio
  module DirectIntBufferRSImports #:nodoc:
  ...
  class DirectIntBufferRS < DirectIntBufferRSImports.const_get :DirectIntBufferS
    include_class_members DirectIntBufferRSImports
    overload_protected {
    ...
    def slice
      ...
      return DirectIntBufferRS.new(self, -1, 0, rem, rem, off)
    end
    ...
    private
    alias_method :initialize__direct_int_buffer_rs, :initialize
  end
