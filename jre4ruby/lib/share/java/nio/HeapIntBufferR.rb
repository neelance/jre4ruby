...
module Java::Nio
  module HeapIntBufferRImports #:nodoc:
  ...
  class HeapIntBufferR < HeapIntBufferRImports.const_get :HeapIntBuffer
    include_class_members HeapIntBufferRImports
    ...
    typesig { [] }
    def slice
      return HeapIntBufferR.new(self.attr_hb, -1, 0, self.remaining, self.remaining, self.position + self.attr_offset)
    end
    ...
    private
    alias_method :initialize__heap_int_buffer_r, :initialize
  end
