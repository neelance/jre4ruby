...
module Java::Nio
  module DirectDoubleBufferRUImports #:nodoc:
  ...
  class DirectDoubleBufferRU < DirectDoubleBufferRUImports.const_get :DirectDoubleBufferU
    include_class_members DirectDoubleBufferRUImports
    overload_protected {
    ...
    def slice
      ...
      return DirectDoubleBufferRU.new(self, -1, 0, rem, rem, off)
    end
    ...
    private
    alias_method :initialize__direct_double_buffer_ru, :initialize
  end
