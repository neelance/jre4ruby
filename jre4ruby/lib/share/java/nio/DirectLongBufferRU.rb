...
module Java::Nio
  module DirectLongBufferRUImports #:nodoc:
  ...
  class DirectLongBufferRU < DirectLongBufferRUImports.const_get :DirectLongBufferU
    include_class_members DirectLongBufferRUImports
    overload_protected {
    ...
    def slice
      ...
      return DirectLongBufferRU.new(self, -1, 0, rem, rem, off)
    end
    ...
    private
    alias_method :initialize__direct_long_buffer_ru, :initialize
  end
