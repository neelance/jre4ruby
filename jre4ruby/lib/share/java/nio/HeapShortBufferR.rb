...
module Java::Nio
  module HeapShortBufferRImports #:nodoc:
  ...
  class HeapShortBufferR < HeapShortBufferRImports.const_get :HeapShortBuffer
    include_class_members HeapShortBufferRImports
    ...
    typesig { [] }
    def slice
      return HeapShortBufferR.new(self.attr_hb, -1, 0, self.remaining, self.remaining, self.position + self.attr_offset)
    end
    ...
    private
    alias_method :initialize__heap_short_buffer_r, :initialize
  end
