...
module Java::Nio
  module DirectIntBufferRUImports #:nodoc:
  ...
  class DirectIntBufferRU < DirectIntBufferRUImports.const_get :DirectIntBufferU
    include_class_members DirectIntBufferRUImports
    overload_protected {
    ...
    def slice
      ...
      return DirectIntBufferRU.new(self, -1, 0, rem, rem, off)
    end
    ...
    private
    alias_method :initialize__direct_int_buffer_ru, :initialize
  end
