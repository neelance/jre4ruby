...
module Java::Nio::Channels
  module ServerSocketChannelImports #:nodoc:
  ...
  # @since 1.4
  class ServerSocketChannel < ServerSocketChannelImports.const_get :AbstractSelectableChannel
    ...
    private
    alias_method :initialize__server_socket_channel, :initialize
  end
