...
module Java::Nio::Channels
  module SelectableChannelImports #:nodoc:
  ...
  # @see SelectionKey
  # @see Selector
  class SelectableChannel < SelectableChannelImports.const_get :AbstractInterruptibleChannel
    include_class_members SelectableChannelImports
    overload_protected {
      include Channel
    }
    ...
    private
    alias_method :initialize__selectable_channel, :initialize
  end
