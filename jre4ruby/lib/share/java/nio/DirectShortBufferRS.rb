...
module Java::Nio
  module DirectShortBufferRSImports #:nodoc:
  ...
  class DirectShortBufferRS < DirectShortBufferRSImports.const_get :DirectShortBufferS
    include_class_members DirectShortBufferRSImports
    overload_protected {
    ...
    def slice
      ...
      return DirectShortBufferRS.new(self, -1, 0, rem, rem, off)
    end
    ...
    private
    alias_method :initialize__direct_short_buffer_rs, :initialize
  end
