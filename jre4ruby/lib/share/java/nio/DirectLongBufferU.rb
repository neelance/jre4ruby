...
module Java::Nio
  module DirectLongBufferUImports #:nodoc:
  ...
  class DirectLongBufferU < DirectLongBufferUImports.const_get :LongBuffer
    ...
    typesig { [] }
    def get
      return ((UnsafeInstance.get_long(ix(next_get_index))))
    end
    
    typesig { [::Java::Int] }
    def get(i)
      return ((UnsafeInstance.get_long(ix(check_index(i)))))
    end
    ...
    typesig { [::Java::Long] }
    def put(x)
      UnsafeInstance.put_long(ix(next_put_index), ((x)))
      return self
    end
    
    typesig { [::Java::Int, ::Java::Long] }
    def put(i, x)
      UnsafeInstance.put_long(ix(check_index(i)), ((x)))
      return self
    end
