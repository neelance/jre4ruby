...
module Java::Nio
  module DirectLongBufferRSImports #:nodoc:
  ...
  class DirectLongBufferRS < DirectLongBufferRSImports.const_get :DirectLongBufferS
    include_class_members DirectLongBufferRSImports
    overload_protected {
    ...
    def slice
      ...
      return DirectLongBufferRS.new(self, -1, 0, rem, rem, off)
    end
    ...
    private
    alias_method :initialize__direct_long_buffer_rs, :initialize
  end
