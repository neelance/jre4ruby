...
module Java::Nio
  module DirectIntBufferSImports #:nodoc:
  ...
  class DirectIntBufferS < DirectIntBufferSImports.const_get :IntBuffer
    ...
    typesig { [] }
    def get
      return (Bits.swap(UnsafeInstance.get_int(ix(next_get_index))))
    end
    
    typesig { [::Java::Int] }
    def get(i)
      return (Bits.swap(UnsafeInstance.get_int(ix(check_index(i)))))
    end
    ...
    typesig { [::Java::Int] }
    def put(x)
      UnsafeInstance.put_int(ix(next_put_index), Bits.swap((x)))
      return self
    end
    
    typesig { [::Java::Int, ::Java::Int] }
    def put(i, x)
      UnsafeInstance.put_int(ix(check_index(i)), Bits.swap((x)))
      return self
    end
