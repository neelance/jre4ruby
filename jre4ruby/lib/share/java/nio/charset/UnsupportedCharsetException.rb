...
module Java::Nio::Charset
  module UnsupportedCharsetExceptionImports #:nodoc:
  ...
  # 
  # @since 1.4
  class UnsupportedCharsetException < UnsupportedCharsetExceptionImports.const_get :IllegalArgumentException
    include_class_members UnsupportedCharsetExceptionImports
    
    class_module.module_eval {
      const_set_lazy(:SerialVersionUID) { 1490765524727386367 }
    ...
    private
    alias_method :initialize__unsupported_charset_exception, :initialize
  end
