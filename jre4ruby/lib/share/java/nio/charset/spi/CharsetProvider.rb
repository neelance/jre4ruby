...
# have any questions.
module Java::Nio::Charset::Spi
  module CharsetProviderImports #:nodoc:
    class_module.module_eval {
      include ::Java::Lang
      include ::Java::Nio::Charset::Spi
  ...
  class CharsetProvider 
    ...
    def initialize
      ...
      if (!(sm).nil?)
        sm.check_permission(RuntimePermission.new("charsetProvider"))
      end
    end
    ...
    private
    alias_method :initialize__charset_provider, :initialize
  end
