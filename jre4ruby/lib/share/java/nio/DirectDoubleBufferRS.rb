...
module Java::Nio
  module DirectDoubleBufferRSImports #:nodoc:
  ...
  class DirectDoubleBufferRS < DirectDoubleBufferRSImports.const_get :DirectDoubleBufferS
    include_class_members DirectDoubleBufferRSImports
    overload_protected {
    ...
    def slice
      ...
      return DirectDoubleBufferRS.new(self, -1, 0, rem, rem, off)
    end
    ...
    private
    alias_method :initialize__direct_double_buffer_rs, :initialize
  end
