...
module Java::Nio
  module ByteBufferAsCharBufferRLImports #:nodoc:
  ...
  class ByteBufferAsCharBufferRL < ByteBufferAsCharBufferRLImports.const_get :ByteBufferAsCharBufferL
    include_class_members ByteBufferAsCharBufferRLImports
    ...
    def slice
      ...
      return ByteBufferAsCharBufferRL.new(self.attr_bb, -1, 0, rem, rem, off)
    end
    
    typesig { [] }
    def duplicate
      return ByteBufferAsCharBufferRL.new(self.attr_bb, self.mark_value, self.position, self.limit, self.capacity, self.attr_offset)
    end
    ...
    def sub_sequence(start, end_)
      ...
      raise AssertError if not ((off >= 0))
      return ByteBufferAsCharBufferRL.new(self.attr_bb, -1, 0, sublen, sublen, off)
    end
    ...
    private
    alias_method :initialize__byte_buffer_as_char_buffer_rl, :initialize
  end
