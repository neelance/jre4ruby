...
module Java::Nio
  module DirectLongBufferSImports #:nodoc:
  ...
  class DirectLongBufferS < DirectLongBufferSImports.const_get :LongBuffer
    ...
    typesig { [] }
    def get
      return (Bits.swap(UnsafeInstance.get_long(ix(next_get_index))))
    end
    
    typesig { [::Java::Int] }
    def get(i)
      return (Bits.swap(UnsafeInstance.get_long(ix(check_index(i)))))
    end
    ...
    typesig { [::Java::Long] }
    def put(x)
      UnsafeInstance.put_long(ix(next_put_index), Bits.swap((x)))
      return self
    end
    
    typesig { [::Java::Int, ::Java::Long] }
    def put(i, x)
      UnsafeInstance.put_long(ix(check_index(i)), Bits.swap((x)))
      return self
    end
