...
module Sun::Text::Resources
  module FormatData_fi_FIImports #:nodoc:
  ...
  class FormatData_fi_FI < FormatData_fi_FIImports.const_get :ListResourceBundle
    include_class_members FormatData_fi_FIImports
    ...
    private
    alias_method :initialize__format_data_fi_fi, :initialize
  end
