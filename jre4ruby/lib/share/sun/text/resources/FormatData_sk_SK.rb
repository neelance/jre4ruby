...
module Sun::Text::Resources
  module FormatData_sk_SKImports #:nodoc:
  ...
  class FormatData_sk_SK < FormatData_sk_SKImports.const_get :ListResourceBundle
    include_class_members FormatData_sk_SKImports
    ...
    private
    alias_method :initialize__format_data_sk_sk, :initialize
  end
