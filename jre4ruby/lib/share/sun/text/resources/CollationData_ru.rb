...
module Sun::Text::Resources
  module CollationData_ruImports #:nodoc:
  ...
  class CollationData_ru < CollationData_ruImports.const_get :ListResourceBundle
    include_class_members CollationData_ruImports
    ...
    private
    alias_method :initialize__collation_data_ru, :initialize
  end
