...
module Sun::Text::Resources
  module FormatData_el_GRImports #:nodoc:
  ...
  class FormatData_el_GR < FormatData_el_GRImports.const_get :ListResourceBundle
    include_class_members FormatData_el_GRImports
    ...
    private
    alias_method :initialize__format_data_el_gr, :initialize
  end
