...
module Sun::Text::Resources
  module FormatData_es_VEImports #:nodoc:
  ...
  class FormatData_es_VE < FormatData_es_VEImports.const_get :ListResourceBundle
    include_class_members FormatData_es_VEImports
    ...
    private
    alias_method :initialize__format_data_es_ve, :initialize
  end
