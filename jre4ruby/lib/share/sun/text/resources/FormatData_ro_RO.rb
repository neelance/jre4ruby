...
module Sun::Text::Resources
  module FormatData_ro_ROImports #:nodoc:
  ...
  class FormatData_ro_RO < FormatData_ro_ROImports.const_get :ListResourceBundle
    include_class_members FormatData_ro_ROImports
    ...
    private
    alias_method :initialize__format_data_ro_ro, :initialize
  end
