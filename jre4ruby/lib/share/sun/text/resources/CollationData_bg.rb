...
module Sun::Text::Resources
  module CollationData_bgImports #:nodoc:
  ...
  class CollationData_bg < CollationData_bgImports.const_get :ListResourceBundle
    include_class_members CollationData_bgImports
    ...
    private
    alias_method :initialize__collation_data_bg, :initialize
  end
