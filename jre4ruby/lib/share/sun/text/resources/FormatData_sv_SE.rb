...
module Sun::Text::Resources
  module FormatData_sv_SEImports #:nodoc:
  ...
  class FormatData_sv_SE < FormatData_sv_SEImports.const_get :ListResourceBundle
    include_class_members FormatData_sv_SEImports
    ...
    private
    alias_method :initialize__format_data_sv_se, :initialize
  end
