...
module Sun::Text::Resources
  module CollationData_huImports #:nodoc:
  ...
  class CollationData_hu < CollationData_huImports.const_get :ListResourceBundle
    include_class_members CollationData_huImports
    ...
    private
    alias_method :initialize__collation_data_hu, :initialize
  end
