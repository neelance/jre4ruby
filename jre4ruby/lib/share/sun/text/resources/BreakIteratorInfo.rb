...
module Sun::Text::Resources
  module BreakIteratorInfoImports #:nodoc:
  ...
  class BreakIteratorInfo < BreakIteratorInfoImports.const_get :ListResourceBundle
    include_class_members BreakIteratorInfoImports
    ...
    private
    alias_method :initialize__break_iterator_info, :initialize
  end
