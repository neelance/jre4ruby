...
module Sun::Text::Resources
  module FormatData_de_DEImports #:nodoc:
  ...
  class FormatData_de_DE < FormatData_de_DEImports.const_get :ListResourceBundle
    include_class_members FormatData_de_DEImports
    ...
    private
    alias_method :initialize__format_data_de_de, :initialize
  end
