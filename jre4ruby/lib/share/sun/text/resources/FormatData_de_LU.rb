...
module Sun::Text::Resources
  module FormatData_de_LUImports #:nodoc:
  ...
  class FormatData_de_LU < FormatData_de_LUImports.const_get :ListResourceBundle
    include_class_members FormatData_de_LUImports
    ...
    private
    alias_method :initialize__format_data_de_lu, :initialize
  end
