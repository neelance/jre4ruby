...
module Sun::Text::Resources
  module CollationData_mkImports #:nodoc:
  ...
  class CollationData_mk < CollationData_mkImports.const_get :ListResourceBundle
    include_class_members CollationData_mkImports
    ...
    private
    alias_method :initialize__collation_data_mk, :initialize
  end
