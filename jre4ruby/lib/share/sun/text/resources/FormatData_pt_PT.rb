...
module Sun::Text::Resources
  module FormatData_pt_PTImports #:nodoc:
  ...
  class FormatData_pt_PT < FormatData_pt_PTImports.const_get :ListResourceBundle
    include_class_members FormatData_pt_PTImports
    ...
    private
    alias_method :initialize__format_data_pt_pt, :initialize
  end
