...
module Sun::Text::Resources
  module CollationData_ukImports #:nodoc:
  ...
  class CollationData_uk < CollationData_ukImports.const_get :ListResourceBundle
    include_class_members CollationData_ukImports
    ...
    private
    alias_method :initialize__collation_data_uk, :initialize
  end
