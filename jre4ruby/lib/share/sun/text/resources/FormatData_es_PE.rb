...
module Sun::Text::Resources
  module FormatData_es_PEImports #:nodoc:
  ...
  class FormatData_es_PE < FormatData_es_PEImports.const_get :ListResourceBundle
    include_class_members FormatData_es_PEImports
    ...
    private
    alias_method :initialize__format_data_es_pe, :initialize
  end
