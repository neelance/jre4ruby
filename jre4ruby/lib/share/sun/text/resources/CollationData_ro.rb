...
module Sun::Text::Resources
  module CollationData_roImports #:nodoc:
  ...
  class CollationData_ro < CollationData_roImports.const_get :ListResourceBundle
    include_class_members CollationData_roImports
    ...
    private
    alias_method :initialize__collation_data_ro, :initialize
  end
