...
module Sun::Text::Resources
  module FormatData_enImports #:nodoc:
  ...
  class FormatData_en < FormatData_enImports.const_get :ListResourceBundle
    include_class_members FormatData_enImports
    ...
    private
    alias_method :initialize__format_data_en, :initialize
  end
