...
module Sun::Text::Resources
  module FormatData_es_UYImports #:nodoc:
  ...
  class FormatData_es_UY < FormatData_es_UYImports.const_get :ListResourceBundle
    include_class_members FormatData_es_UYImports
    ...
    private
    alias_method :initialize__format_data_es_uy, :initialize
  end
