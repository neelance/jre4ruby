...
module Sun::Text::Resources
  module FormatData_skImports #:nodoc:
  ...
  class FormatData_sk < FormatData_skImports.const_get :ListResourceBundle
    include_class_members FormatData_skImports
    ...
    private
    alias_method :initialize__format_data_sk, :initialize
  end
