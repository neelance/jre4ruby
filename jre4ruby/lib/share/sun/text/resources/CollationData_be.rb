...
module Sun::Text::Resources
  module CollationData_beImports #:nodoc:
  ...
  class CollationData_be < CollationData_beImports.const_get :ListResourceBundle
    include_class_members CollationData_beImports
    ...
    private
    alias_method :initialize__collation_data_be, :initialize
  end
