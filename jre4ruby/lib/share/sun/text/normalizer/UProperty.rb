...
module Sun::Text::Normalizer
  ...
  module UProperty
    include_class_members UPropertyImports
    ...
    class_module.module_eval {
      ...
      # @stable ICU 2.6
      const_set_lazy(:HANGUL_SYLLABLE_TYPE) { 0x100b }
      const_attr_reader  :HANGUL_SYLLABLE_TYPE
      ...
      # @stable ICU 2.4
      const_set_lazy(:GENERAL_CATEGORY_MASK) { 0x2000 }
      const_attr_reader  :GENERAL_CATEGORY_MASK
    }
  end
