  ...
  class NormalizerBase 
    ...
    class_module.module_eval {
      ...
      const_set_lazy(:Mode) { Class.new do
        ...
        typesig { [Array.typed(::Java::Char), ::Java::Int, ::Java::Int, Array.typed(::Java::Char), ::Java::Int, ::Java::Int, UnicodeSet] }
        ...
        typesig { [Array.typed(::Java::Char), ::Java::Int, ::Java::Int, ::Java::Boolean, UnicodeSet] }
        # This method is used for method dispatch
        # @stable ICU 2.6
      ...
      const_set_lazy(:NFDMode) { Class.new(Mode) do
        ...
        typesig { [] }
        def get_prev_boundary
          return IsPrevNFDSafe.new
        end
        
        typesig { [] }
        def get_next_boundary
          return IsNextNFDSafe.new
        end
      ...
      const_set_lazy(:NFCMode) { Class.new(Mode) do
        ...
        typesig { [] }
        def get_prev_boundary
          return IsPrevTrueStarter.new
        end
        
        typesig { [] }
        def get_next_boundary
          return IsNextTrueStarter.new
        end
