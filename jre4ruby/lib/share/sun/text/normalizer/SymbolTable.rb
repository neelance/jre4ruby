...
module Sun::Text::Normalizer
  module SymbolTableImports #:nodoc:
  ...
  module SymbolTable
    include_class_members SymbolTableImports
    
    class_module.module_eval {
      # The character preceding a symbol reference name.
      # @draft ICU 2.8
      # @deprecated This is a draft API and might change in a future release of ICU.
      const_set_lazy(:SYMBOL_REF) { Character.new(?$.ord) }
      const_attr_reader  :SYMBOL_REF
    }
    ...
    # @draft ICU 2.8
    # @deprecated This is a draft API and might change in a future release of ICU.
    def lookup_matcher(ch)
      raise NotImplementedError
    end
    
    typesig { [String, ParsePosition, ::Java::Int] }
    ...
    # @draft ICU 2.8
    # @deprecated This is a draft API and might change in a future release of ICU.
    def parse_reference(text, pos, limit)
      raise NotImplementedError
    end
  end
