...
# have any questions.
module Sun::Reflect
  module UnsafeQualifiedStaticShortFieldAccessorImplImports #:nodoc:
  ...
  class UnsafeQualifiedStaticShortFieldAccessorImpl < UnsafeQualifiedStaticShortFieldAccessorImplImports.const_get :UnsafeQualifiedStaticFieldAccessorImpl
    include_class_members UnsafeQualifiedStaticShortFieldAccessorImplImports
    ...
    typesig { [Object] }
    def get(obj)
      return Short.new(get_short(obj))
    end
    ...
    typesig { [Object] }
    def get_short(obj)
      return self.attr_unsafe.get_short_volatile(self.attr_base, self.attr_field_offset)
    end
    
    typesig { [Object] }
    def get_int(obj)
      return get_short(obj)
    end
    ...
    def set(obj, value)
      ...
      if (value.is_a?(Byte))
        self.attr_unsafe.put_short_volatile(self.attr_base, self.attr_field_offset, (value).byte_value)
        return
      end
      if (value.is_a?(Short))
        self.attr_unsafe.put_short_volatile(self.attr_base, self.attr_field_offset, (value).short_value)
        return
      end
      throw_set_illegal_argument_exception(value)
    end
    ...
    def set_short(obj, s)
      if (self.attr_is_read_only)
        throw_final_field_illegal_access_exception(s)
      end
      self.attr_unsafe.put_short_volatile(self.attr_base, self.attr_field_offset, s)
    end
    ...
    private
    alias_method :initialize__unsafe_qualified_static_short_field_accessor_impl, :initialize
  end
