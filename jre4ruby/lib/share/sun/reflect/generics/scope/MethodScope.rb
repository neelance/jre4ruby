...
module Sun::Reflect::Generics::Scope
  module MethodScopeImports #:nodoc:
  ...
  # a method.
  class MethodScope < MethodScopeImports.const_get :AbstractScope
    include_class_members MethodScopeImports
    ...
    class_module.module_eval {
      ...
      def make(m)
        return MethodScope.new(m)
      end
    }
    
    private
    alias_method :initialize__method_scope, :initialize
  end
