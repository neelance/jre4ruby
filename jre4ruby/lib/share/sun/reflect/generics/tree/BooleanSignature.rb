...
module Sun::Reflect::Generics::Tree
  module BooleanSignatureImports #:nodoc:
  ...
  class BooleanSignature 
    include_class_members BooleanSignatureImports
    include BaseType
    
    class_module.module_eval {
      
      def singleton
        defined?(@@singleton) ? @@singleton : @@singleton= BooleanSignature.new
      end
    ...
    def accept(v)
      v.visit_boolean_signature(self)
    end
    
    private
    alias_method :initialize__boolean_signature, :initialize
  end
