...
module Sun::Reflect::Generics::Tree
  module TypeVariableSignatureImports #:nodoc:
  ...
  class TypeVariableSignature 
    include_class_members TypeVariableSignatureImports
    ...
    class_module.module_eval {
      typesig { [String] }
      def make(id)
        return TypeVariableSignature.new(id)
      end
    }
    ...
    def accept(v)
      v.visit_type_variable_signature(self)
    end
    
    private
    alias_method :initialize__type_variable_signature, :initialize
  end
