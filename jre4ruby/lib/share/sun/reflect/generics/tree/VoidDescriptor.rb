...
module Sun::Reflect::Generics::Tree
  module VoidDescriptorImports #:nodoc:
  ...
  class VoidDescriptor 
    include_class_members VoidDescriptorImports
    include ReturnType
    
    class_module.module_eval {
      
      def singleton
        defined?(@@singleton) ? @@singleton : @@singleton= VoidDescriptor.new
      end
    ...
    def accept(v)
      v.visit_void_descriptor(self)
    end
    
    private
    alias_method :initialize__void_descriptor, :initialize
  end
