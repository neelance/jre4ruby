...
# have any questions.
module Sun::Reflect
  module SerializationConstructorAccessorImplImports #:nodoc:
  ...
  class SerializationConstructorAccessorImpl < SerializationConstructorAccessorImplImports.const_get :ConstructorAccessorImpl
    include_class_members SerializationConstructorAccessorImplImports
    ...
    private
    alias_method :initialize__serialization_constructor_accessor_impl, :initialize
  end
