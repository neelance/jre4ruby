...
# have any questions.
module Sun::Reflect
  module UnsafeStaticIntegerFieldAccessorImplImports #:nodoc:
  ...
  class UnsafeStaticIntegerFieldAccessorImpl < UnsafeStaticIntegerFieldAccessorImplImports.const_get :UnsafeStaticFieldAccessorImpl
    include_class_members UnsafeStaticIntegerFieldAccessorImplImports
    ...
    typesig { [Object] }
    def get_int(obj)
      return self.attr_unsafe.get_int(self.attr_base, self.attr_field_offset)
    end
    ...
    def set(obj, value)
      ...
      if (value.is_a?(Byte))
        self.attr_unsafe.put_int(self.attr_base, self.attr_field_offset, (value).byte_value)
        return
      end
      if (value.is_a?(Short))
        self.attr_unsafe.put_int(self.attr_base, self.attr_field_offset, (value).short_value)
        return
      end
      if (value.is_a?(Character))
        self.attr_unsafe.put_int(self.attr_base, self.attr_field_offset, (value).char_value)
        return
      end
      if (value.is_a?(JavaInteger))
        self.attr_unsafe.put_int(self.attr_base, self.attr_field_offset, (value).int_value)
        return
      end
      throw_set_illegal_argument_exception(value)
    end
    ...
    def set_int(obj, i)
      ...
      self.attr_unsafe.put_int(self.attr_base, self.attr_field_offset, i)
    end
    ...
    private
    alias_method :initialize__unsafe_static_integer_field_accessor_impl, :initialize
  end
