...
# have any questions.
module Sun::Reflect
  module UnsafeQualifiedLongFieldAccessorImplImports #:nodoc:
  ...
  class UnsafeQualifiedLongFieldAccessorImpl < UnsafeQualifiedLongFieldAccessorImplImports.const_get :UnsafeQualifiedFieldAccessorImpl
    include_class_members UnsafeQualifiedLongFieldAccessorImplImports
    ...
    def get_long(obj)
      ensure_obj(obj)
      return self.attr_unsafe.get_long_volatile(obj, self.attr_field_offset)
    end
    ...
    def set(obj, value)
      ...
      if (value.is_a?(Byte))
        self.attr_unsafe.put_long_volatile(obj, self.attr_field_offset, (value).byte_value)
        return
      end
      if (value.is_a?(Short))
        self.attr_unsafe.put_long_volatile(obj, self.attr_field_offset, (value).short_value)
        return
      end
      if (value.is_a?(Character))
        self.attr_unsafe.put_long_volatile(obj, self.attr_field_offset, (value).char_value)
        return
      end
      if (value.is_a?(JavaInteger))
        self.attr_unsafe.put_long_volatile(obj, self.attr_field_offset, (value).int_value)
        return
      end
      if (value.is_a?(Long))
        self.attr_unsafe.put_long_volatile(obj, self.attr_field_offset, (value).long_value)
        return
      end
      throw_set_illegal_argument_exception(value)
    end
    ...
    def set_long(obj, l)
      ...
      self.attr_unsafe.put_long_volatile(obj, self.attr_field_offset, l)
    end
    ...
    private
    alias_method :initialize__unsafe_qualified_long_field_accessor_impl, :initialize
  end
