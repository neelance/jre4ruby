...
# have any questions.
module Sun::Reflect
  module UnsafeQualifiedCharacterFieldAccessorImplImports #:nodoc:
  ...
  class UnsafeQualifiedCharacterFieldAccessorImpl < UnsafeQualifiedCharacterFieldAccessorImplImports.const_get :UnsafeQualifiedFieldAccessorImpl
    include_class_members UnsafeQualifiedCharacterFieldAccessorImplImports
    ...
    def get_char(obj)
      ensure_obj(obj)
      return self.attr_unsafe.get_char_volatile(obj, self.attr_field_offset)
    end
    ...
    def set(obj, value)
      ...
      if (value.is_a?(Character))
        self.attr_unsafe.put_char_volatile(obj, self.attr_field_offset, (value).char_value)
        return
      end
      throw_set_illegal_argument_exception(value)
    end
    ...
    def set_char(obj, c)
      ...
      self.attr_unsafe.put_char_volatile(obj, self.attr_field_offset, c)
    end
    ...
    private
    alias_method :initialize__unsafe_qualified_character_field_accessor_impl, :initialize
  end
