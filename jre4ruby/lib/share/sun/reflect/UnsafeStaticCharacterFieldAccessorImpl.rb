...
# have any questions.
module Sun::Reflect
  module UnsafeStaticCharacterFieldAccessorImplImports #:nodoc:
  ...
  class UnsafeStaticCharacterFieldAccessorImpl < UnsafeStaticCharacterFieldAccessorImplImports.const_get :UnsafeStaticFieldAccessorImpl
    include_class_members UnsafeStaticCharacterFieldAccessorImplImports
    ...
    typesig { [Object] }
    def get_char(obj)
      return self.attr_unsafe.get_char(self.attr_base, self.attr_field_offset)
    end
    ...
    def set(obj, value)
      ...
      if (value.is_a?(Character))
        self.attr_unsafe.put_char(self.attr_base, self.attr_field_offset, (value).char_value)
        return
      end
      throw_set_illegal_argument_exception(value)
    end
    ...
    def set_char(obj, c)
      ...
      self.attr_unsafe.put_char(self.attr_base, self.attr_field_offset, c)
    end
    ...
    private
    alias_method :initialize__unsafe_static_character_field_accessor_impl, :initialize
  end
