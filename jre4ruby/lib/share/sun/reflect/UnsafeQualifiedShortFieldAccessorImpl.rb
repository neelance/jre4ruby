...
# have any questions.
module Sun::Reflect
  module UnsafeQualifiedShortFieldAccessorImplImports #:nodoc:
  ...
  class UnsafeQualifiedShortFieldAccessorImpl < UnsafeQualifiedShortFieldAccessorImplImports.const_get :UnsafeQualifiedFieldAccessorImpl
    include_class_members UnsafeQualifiedShortFieldAccessorImplImports
    ...
    def get_short(obj)
      ensure_obj(obj)
      return self.attr_unsafe.get_short_volatile(obj, self.attr_field_offset)
    end
    ...
    def set(obj, value)
      ...
      if (value.is_a?(Byte))
        self.attr_unsafe.put_short_volatile(obj, self.attr_field_offset, (value).byte_value)
        return
      end
      if (value.is_a?(Short))
        self.attr_unsafe.put_short_volatile(obj, self.attr_field_offset, (value).short_value)
        return
      end
      throw_set_illegal_argument_exception(value)
    end
    ...
    def set_short(obj, s)
      ...
      self.attr_unsafe.put_short_volatile(obj, self.attr_field_offset, s)
    end
    ...
    private
    alias_method :initialize__unsafe_qualified_short_field_accessor_impl, :initialize
  end
