...
# have any questions.
module Sun::Reflect
  module UnsafeStaticObjectFieldAccessorImplImports #:nodoc:
  ...
  class UnsafeStaticObjectFieldAccessorImpl < UnsafeStaticObjectFieldAccessorImplImports.const_get :UnsafeStaticFieldAccessorImpl
    include_class_members UnsafeStaticObjectFieldAccessorImplImports
    ...
    typesig { [Object] }
    def get(obj)
      return self.attr_unsafe.get_object(self.attr_base, self.attr_field_offset)
    end
    ...
    def set(obj, value)
      ...
      self.attr_unsafe.put_object(self.attr_base, self.attr_field_offset, value)
    end
    ...
    private
    alias_method :initialize__unsafe_static_object_field_accessor_impl, :initialize
  end
