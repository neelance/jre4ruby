...
# have any questions.
module Sun::Reflect
  module UnsafeCharacterFieldAccessorImplImports #:nodoc:
  ...
  class UnsafeCharacterFieldAccessorImpl < UnsafeCharacterFieldAccessorImplImports.const_get :UnsafeFieldAccessorImpl
    include_class_members UnsafeCharacterFieldAccessorImplImports
    ...
    def get_char(obj)
      ensure_obj(obj)
      return self.attr_unsafe.get_char(obj, self.attr_field_offset)
    end
    ...
    def set(obj, value)
      ...
      if (value.is_a?(Character))
        self.attr_unsafe.put_char(obj, self.attr_field_offset, (value).char_value)
        return
      end
      throw_set_illegal_argument_exception(value)
    end
    ...
    def set_char(obj, c)
      ...
      self.attr_unsafe.put_char(obj, self.attr_field_offset, c)
    end
    ...
    private
    alias_method :initialize__unsafe_character_field_accessor_impl, :initialize
  end
