...
# have any questions.
module Sun::Reflect
  module UnsafeQualifiedStaticObjectFieldAccessorImplImports #:nodoc:
  ...
  class UnsafeQualifiedStaticObjectFieldAccessorImpl < UnsafeQualifiedStaticObjectFieldAccessorImplImports.const_get :UnsafeQualifiedStaticFieldAccessorImpl
    include_class_members UnsafeQualifiedStaticObjectFieldAccessorImplImports
    ...
    typesig { [Object] }
    def get(obj)
      return self.attr_unsafe.get_object_volatile(self.attr_base, self.attr_field_offset)
    end
    ...
    def set(obj, value)
      ...
      if (!(value).nil?)
        if (!self.attr_field.get_type.is_assignable_from(value.get_class))
          throw_set_illegal_argument_exception(value)
        end
      end
      self.attr_unsafe.put_object_volatile(self.attr_base, self.attr_field_offset, value)
    end
    ...
    private
    alias_method :initialize__unsafe_qualified_static_object_field_accessor_impl, :initialize
  end
