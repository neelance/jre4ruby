...
# have any questions.
module Sun::Reflect
  module UnsafeStaticBooleanFieldAccessorImplImports #:nodoc:
  ...
  class UnsafeStaticBooleanFieldAccessorImpl < UnsafeStaticBooleanFieldAccessorImplImports.const_get :UnsafeStaticFieldAccessorImpl
    include_class_members UnsafeStaticBooleanFieldAccessorImplImports
    ...
    typesig { [Object] }
    def get_boolean(obj)
      return self.attr_unsafe.get_boolean(self.attr_base, self.attr_field_offset)
    end
    ...
    def set(obj, value)
      ...
      if (value.is_a?(Boolean))
        self.attr_unsafe.put_boolean(self.attr_base, self.attr_field_offset, (value).boolean_value)
        return
      end
      throw_set_illegal_argument_exception(value)
    end
    ...
    def set_boolean(obj, z)
      ...
      self.attr_unsafe.put_boolean(self.attr_base, self.attr_field_offset, z)
    end
    ...
    private
    alias_method :initialize__unsafe_static_boolean_field_accessor_impl, :initialize
  end
