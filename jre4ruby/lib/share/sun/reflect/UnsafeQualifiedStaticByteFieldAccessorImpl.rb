...
# have any questions.
module Sun::Reflect
  module UnsafeQualifiedStaticByteFieldAccessorImplImports #:nodoc:
  ...
  class UnsafeQualifiedStaticByteFieldAccessorImpl < UnsafeQualifiedStaticByteFieldAccessorImplImports.const_get :UnsafeQualifiedStaticFieldAccessorImpl
    include_class_members UnsafeQualifiedStaticByteFieldAccessorImplImports
    ...
    typesig { [Object] }
    def get_byte(obj)
      return self.attr_unsafe.get_byte_volatile(self.attr_base, self.attr_field_offset)
    end
    ...
    def set(obj, value)
      ...
      if (value.is_a?(Byte))
        self.attr_unsafe.put_byte_volatile(self.attr_base, self.attr_field_offset, (value).byte_value)
        return
      end
      throw_set_illegal_argument_exception(value)
    end
    ...
    def set_byte(obj, b)
      if (self.attr_is_read_only)
        throw_final_field_illegal_access_exception(b)
      end
      self.attr_unsafe.put_byte_volatile(self.attr_base, self.attr_field_offset, b)
    end
    ...
    private
    alias_method :initialize__unsafe_qualified_static_byte_field_accessor_impl, :initialize
  end
