...
# have any questions.
module Sun::Reflect
  module UnsafeStaticShortFieldAccessorImplImports #:nodoc:
  ...
  class UnsafeStaticShortFieldAccessorImpl < UnsafeStaticShortFieldAccessorImplImports.const_get :UnsafeStaticFieldAccessorImpl
    include_class_members UnsafeStaticShortFieldAccessorImplImports
    ...
    typesig { [Object] }
    def get_short(obj)
      return self.attr_unsafe.get_short(self.attr_base, self.attr_field_offset)
    end
    ...
    def set(obj, value)
      ...
      if (value.is_a?(Byte))
        self.attr_unsafe.put_short(self.attr_base, self.attr_field_offset, (value).byte_value)
        return
      end
      if (value.is_a?(Short))
        self.attr_unsafe.put_short(self.attr_base, self.attr_field_offset, (value).short_value)
        return
      end
      throw_set_illegal_argument_exception(value)
    end
    ...
    def set_short(obj, s)
      ...
      self.attr_unsafe.put_short(self.attr_base, self.attr_field_offset, s)
    end
    ...
    private
    alias_method :initialize__unsafe_static_short_field_accessor_impl, :initialize
  end
