...
# have any questions.
module Sun::Reflect
  module UnsafeQualifiedByteFieldAccessorImplImports #:nodoc:
  ...
  class UnsafeQualifiedByteFieldAccessorImpl < UnsafeQualifiedByteFieldAccessorImplImports.const_get :UnsafeQualifiedFieldAccessorImpl
    include_class_members UnsafeQualifiedByteFieldAccessorImplImports
    ...
    def get_byte(obj)
      ensure_obj(obj)
      return self.attr_unsafe.get_byte_volatile(obj, self.attr_field_offset)
    end
    ...
    def set(obj, value)
      ...
      if (value.is_a?(Byte))
        self.attr_unsafe.put_byte_volatile(obj, self.attr_field_offset, (value).byte_value)
        return
      end
      throw_set_illegal_argument_exception(value)
    end
    ...
    def set_byte(obj, b)
      ...
      self.attr_unsafe.put_byte_volatile(obj, self.attr_field_offset, b)
    end
    ...
    private
    alias_method :initialize__unsafe_qualified_byte_field_accessor_impl, :initialize
  end
