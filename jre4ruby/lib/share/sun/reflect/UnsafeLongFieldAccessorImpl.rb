...
# have any questions.
module Sun::Reflect
  module UnsafeLongFieldAccessorImplImports #:nodoc:
  ...
  class UnsafeLongFieldAccessorImpl < UnsafeLongFieldAccessorImplImports.const_get :UnsafeFieldAccessorImpl
    include_class_members UnsafeLongFieldAccessorImplImports
    ...
    def get_long(obj)
      ensure_obj(obj)
      return self.attr_unsafe.get_long(obj, self.attr_field_offset)
    end
    ...
    def set(obj, value)
      ...
      if (value.is_a?(Byte))
        self.attr_unsafe.put_long(obj, self.attr_field_offset, (value).byte_value)
        return
      end
      if (value.is_a?(Short))
        self.attr_unsafe.put_long(obj, self.attr_field_offset, (value).short_value)
        return
      end
      if (value.is_a?(Character))
        self.attr_unsafe.put_long(obj, self.attr_field_offset, (value).char_value)
        return
      end
      if (value.is_a?(JavaInteger))
        self.attr_unsafe.put_long(obj, self.attr_field_offset, (value).int_value)
        return
      end
      if (value.is_a?(Long))
        self.attr_unsafe.put_long(obj, self.attr_field_offset, (value).long_value)
        return
      end
      throw_set_illegal_argument_exception(value)
    end
    ...
    def set_long(obj, l)
      ...
      self.attr_unsafe.put_long(obj, self.attr_field_offset, l)
    end
    ...
    private
    alias_method :initialize__unsafe_long_field_accessor_impl, :initialize
  end
