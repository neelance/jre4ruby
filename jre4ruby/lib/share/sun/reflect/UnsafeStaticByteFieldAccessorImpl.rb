...
# have any questions.
module Sun::Reflect
  module UnsafeStaticByteFieldAccessorImplImports #:nodoc:
  ...
  class UnsafeStaticByteFieldAccessorImpl < UnsafeStaticByteFieldAccessorImplImports.const_get :UnsafeStaticFieldAccessorImpl
    include_class_members UnsafeStaticByteFieldAccessorImplImports
    ...
    typesig { [Object] }
    def get_byte(obj)
      return self.attr_unsafe.get_byte(self.attr_base, self.attr_field_offset)
    end
    ...
    def set(obj, value)
      ...
      if (value.is_a?(Byte))
        self.attr_unsafe.put_byte(self.attr_base, self.attr_field_offset, (value).byte_value)
        return
      end
      throw_set_illegal_argument_exception(value)
    end
    ...
    def set_byte(obj, b)
      ...
      self.attr_unsafe.put_byte(self.attr_base, self.attr_field_offset, b)
    end
    ...
    private
    alias_method :initialize__unsafe_static_byte_field_accessor_impl, :initialize
  end
