...
# have any questions.
module Sun::Reflect
  module UnsafeQualifiedStaticCharacterFieldAccessorImplImports #:nodoc:
  ...
  class UnsafeQualifiedStaticCharacterFieldAccessorImpl < UnsafeQualifiedStaticCharacterFieldAccessorImplImports.const_get :UnsafeQualifiedStaticFieldAccessorImpl
    include_class_members UnsafeQualifiedStaticCharacterFieldAccessorImplImports
    ...
    typesig { [Object] }
    def get(obj)
      return Character.new(get_char(obj))
    end
    ...
    typesig { [Object] }
    def get_char(obj)
      return self.attr_unsafe.get_char_volatile(self.attr_base, self.attr_field_offset)
    end
    ...
    def set(obj, value)
      ...
      if (value.is_a?(Character))
        self.attr_unsafe.put_char_volatile(self.attr_base, self.attr_field_offset, (value).char_value)
        return
      end
      throw_set_illegal_argument_exception(value)
    end
    ...
    def set_char(obj, c)
      if (self.attr_is_read_only)
        throw_final_field_illegal_access_exception(c)
      end
      self.attr_unsafe.put_char_volatile(self.attr_base, self.attr_field_offset, c)
    end
    ...
    private
    alias_method :initialize__unsafe_qualified_static_character_field_accessor_impl, :initialize
  end
