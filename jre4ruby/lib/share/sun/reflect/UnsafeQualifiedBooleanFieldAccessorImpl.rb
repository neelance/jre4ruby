...
# have any questions.
module Sun::Reflect
  module UnsafeQualifiedBooleanFieldAccessorImplImports #:nodoc:
  ...
  class UnsafeQualifiedBooleanFieldAccessorImpl < UnsafeQualifiedBooleanFieldAccessorImplImports.const_get :UnsafeQualifiedFieldAccessorImpl
    include_class_members UnsafeQualifiedBooleanFieldAccessorImplImports
    ...
    def get_boolean(obj)
      ensure_obj(obj)
      return self.attr_unsafe.get_boolean_volatile(obj, self.attr_field_offset)
    end
    ...
    def set(obj, value)
      ...
      if (value.is_a?(Boolean))
        self.attr_unsafe.put_boolean_volatile(obj, self.attr_field_offset, (value).boolean_value)
        return
      end
      throw_set_illegal_argument_exception(value)
    end
    ...
    def set_boolean(obj, z)
      ...
      self.attr_unsafe.put_boolean_volatile(obj, self.attr_field_offset, z)
    end
    ...
    private
    alias_method :initialize__unsafe_qualified_boolean_field_accessor_impl, :initialize
  end
