...
# have any questions.
module Sun::Reflect
  module UnsafeObjectFieldAccessorImplImports #:nodoc:
  ...
  class UnsafeObjectFieldAccessorImpl < UnsafeObjectFieldAccessorImplImports.const_get :UnsafeFieldAccessorImpl
    include_class_members UnsafeObjectFieldAccessorImplImports
    ...
    def get(obj)
      ensure_obj(obj)
      return self.attr_unsafe.get_object(obj, self.attr_field_offset)
    end
    ...
    def set(obj, value)
      ...
      self.attr_unsafe.put_object(obj, self.attr_field_offset, value)
    end
    ...
    private
    alias_method :initialize__unsafe_object_field_accessor_impl, :initialize
  end
