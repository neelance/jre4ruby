...
# have any questions.
module Sun::Reflect
  module UnsafeQualifiedObjectFieldAccessorImplImports #:nodoc:
  ...
  class UnsafeQualifiedObjectFieldAccessorImpl < UnsafeQualifiedObjectFieldAccessorImplImports.const_get :UnsafeQualifiedFieldAccessorImpl
    include_class_members UnsafeQualifiedObjectFieldAccessorImplImports
    ...
    def get(obj)
      ensure_obj(obj)
      return self.attr_unsafe.get_object_volatile(obj, self.attr_field_offset)
    end
    ...
    def set(obj, value)
      ...
      self.attr_unsafe.put_object_volatile(obj, self.attr_field_offset, value)
    end
    ...
    private
    alias_method :initialize__unsafe_qualified_object_field_accessor_impl, :initialize
  end
