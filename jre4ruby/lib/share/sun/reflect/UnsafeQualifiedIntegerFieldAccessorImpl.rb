...
# have any questions.
module Sun::Reflect
  module UnsafeQualifiedIntegerFieldAccessorImplImports #:nodoc:
  ...
  class UnsafeQualifiedIntegerFieldAccessorImpl < UnsafeQualifiedIntegerFieldAccessorImplImports.const_get :UnsafeQualifiedFieldAccessorImpl
    include_class_members UnsafeQualifiedIntegerFieldAccessorImplImports
    ...
    def get_int(obj)
      ensure_obj(obj)
      return self.attr_unsafe.get_int_volatile(obj, self.attr_field_offset)
    end
    ...
    def set(obj, value)
      ...
      if (value.is_a?(Byte))
        self.attr_unsafe.put_int_volatile(obj, self.attr_field_offset, (value).byte_value)
        return
      end
      if (value.is_a?(Short))
        self.attr_unsafe.put_int_volatile(obj, self.attr_field_offset, (value).short_value)
        return
      end
      if (value.is_a?(Character))
        self.attr_unsafe.put_int_volatile(obj, self.attr_field_offset, (value).char_value)
        return
      end
      if (value.is_a?(JavaInteger))
        self.attr_unsafe.put_int_volatile(obj, self.attr_field_offset, (value).int_value)
        return
      end
      throw_set_illegal_argument_exception(value)
    end
    ...
    def set_int(obj, i)
      ...
      self.attr_unsafe.put_int_volatile(obj, self.attr_field_offset, i)
    end
    ...
    private
    alias_method :initialize__unsafe_qualified_integer_field_accessor_impl, :initialize
  end
