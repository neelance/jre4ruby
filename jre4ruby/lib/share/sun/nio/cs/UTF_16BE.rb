...
module Sun::Nio::Cs
  ...
  class UTF_16BE < UTF_16BEImports.const_get :Unicode
    include_class_members UTF_16BEImports
    
    typesig { [] }
    def initialize
      super("UTF-16BE", StandardCharsets.attr_aliases_utf_16be)
    end
    ...
    class_module.module_eval {
      const_set_lazy(:Decoder) { Class.new(UnicodeDecoder) do
        include_class_members UTF_16BE
    ...
    private
    alias_method :initialize__utf_16be, :initialize
  end
