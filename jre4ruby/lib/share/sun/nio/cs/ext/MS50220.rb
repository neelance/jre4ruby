...
module Sun::Nio::Cs::Ext
  ...
  class MS50220 < MS50220Imports.const_get :ISO2022_JP
    include_class_members MS50220Imports
    
    typesig { [] }
    def initialize
      super("x-windows-50220", ExtendedCharsets.aliases_for("x-windows-50220"))
    end
    ...
    typesig { [Charset] }
    def contains(cs)
      return super(cs) || (cs.is_a?(JIS_X_0212)) || (cs.is_a?(MS50220))
    end
    ...
    private
    alias_method :initialize__ms50220, :initialize
  end
