...
module Sun::Nio::Cs::Ext
  ...
  class TIS_620 < TIS_620Imports.const_get :Charset
    include_class_members TIS_620Imports
    overload_protected {
    ...
    typesig { [] }
    def initialize
      super("TIS-620", ExtendedCharsets.aliases_for("TIS-620"))
    end
    ...
    typesig { [Charset] }
    def contains(cs)
      return (((cs.name == "US-ASCII")) || (cs.is_a?(TIS_620)))
    end
    ...
    private
    alias_method :initialize__tis_620, :initialize
  end
