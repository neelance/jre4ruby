      ...
      const_set_lazy(:Decoder) { Class.new(IBM942::Decoder) do
        ...
        class_module.module_eval {
          when_class_loaded do
            ...
            const_set :SingleByteToChar, indexs + RJava.cast_to_string(IBM942::Decoder.attr_single_byte_to_char.substring(indexs.length))
          end
        }
      ...
      const_set_lazy(:Encoder) { Class.new(IBM942::Encoder) do
        ...
        class_module.module_eval {
          ...
          when_class_loaded do
            ...
            const_set :Index2a, RJava.cast_to_string(IBM942::Encoder.attr_index2a) + indexs
