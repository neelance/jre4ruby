...
module Sun::Nio::Cs::Ext
  module JISAutoDetectImports #:nodoc:
  ...
  class JISAutoDetect < JISAutoDetectImports.const_get :Charset
    ...
    class_module.module_eval {
      ...
      const_set_lazy(:Decoder) { Class.new(CharsetDecoder) do
        ...
        typesig { [class_self::Charset, class_self::ByteBuffer, class_self::CharBuffer] }
        ...
        class_module.module_eval {
          ...
          def get_sjisname
            os_name = AccessController.do_privileged(class_self::GetPropertyAction.new("os.name"))
