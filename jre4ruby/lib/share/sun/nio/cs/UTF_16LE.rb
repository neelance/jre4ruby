...
module Sun::Nio::Cs
  ...
  class UTF_16LE < UTF_16LEImports.const_get :Unicode
    include_class_members UTF_16LEImports
    
    typesig { [] }
    def initialize
      super("UTF-16LE", StandardCharsets.attr_aliases_utf_16le)
    end
    ...
    class_module.module_eval {
      const_set_lazy(:Decoder) { Class.new(UnicodeDecoder) do
        include_class_members UTF_16LE
    ...
    private
    alias_method :initialize__utf_16le, :initialize
  end
