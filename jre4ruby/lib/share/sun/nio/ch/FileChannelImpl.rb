...
# have any questions.
module Sun::Nio::Ch
  module FileChannelImplImports #:nodoc:
  ...
  class FileChannelImpl < FileChannelImplImports.const_get :FileChannel
    ...
    class_module.module_eval {
      ...
      def is_shared_file_lock_table
        if (!self.attr_property_checked)
          synchronized((FileChannelImpl)) do
            if (!self.attr_property_checked)
    ...
    class_module.module_eval {
      ...
      const_set_lazy(:SimpleFileLockTable) { Class.new do
        ...
        typesig { [class_self::FileLock, class_self::FileLock] }
        def replace(fl1, fl2)
          synchronized((@lock_list)) do
      ...
      const_set_lazy(:FileLockReference) { Class.new(WeakReference) do
        ...
        typesig { [class_self::FileLock, class_self::ReferenceQueue, class_self::FileKey] }
      ...
      const_set_lazy(:SharedFileLockTable) { Class.new do
        ...
        class_module.module_eval {
          ...
          def lock_map
            defined?(@@lock_map) ? @@lock_map : @@lock_map= class_self::ConcurrentHashMap.new
          end
          ...
          def queue
            defined?(@@queue) ? @@queue : @@queue= class_self::ReferenceQueue.new
          end
        ...
        typesig { [class_self::FileChannelImpl] }
        def initialize(fci)
          @fci = nil
          @file_key = nil
          @fci = fci
        ...
        typesig { [class_self::FileKey, class_self::ArrayList] }
        ...
        typesig { [class_self::JavaList, ::Java::Long, ::Java::Long] }
