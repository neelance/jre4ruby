...
module Sun::Util
  ...
  class LocaleDataMetaInfo 
    include_class_members LocaleDataMetaInfoImports
    
    class_module.module_eval {
      const_set_lazy(:ResourceNameToLocales) { HashMap.new(6) }
      const_attr_reader  :ResourceNameToLocales
      ...
      def get_supported_locale_string(resource_name)
        return ResourceNameToLocales.get(resource_name)
      end
    }
    ...
    private
    alias_method :initialize__locale_data_meta_info, :initialize
  end
