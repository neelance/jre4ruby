...
module Sun::Util::Resources
  module TimeZoneNames_enImports #:nodoc:
  ...
  class TimeZoneNames_en < TimeZoneNames_enImports.const_get :TimeZoneNamesBundle
    include_class_members TimeZoneNames_enImports
    ...
    private
    alias_method :initialize__time_zone_names_en, :initialize
  end
