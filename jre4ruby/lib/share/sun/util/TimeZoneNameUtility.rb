...
# have any questions.
module Sun::Util
  module TimeZoneNameUtilityImports #:nodoc:
  ...
  class TimeZoneNameUtility 
    ...
    class_module.module_eval {
      ...
      def retrieve_display_names(rb, id, locale)
        pool = LocaleServiceProviderPool.get_pool(TimeZoneNameProvider)
        names = nil
      ...
      const_set_lazy(:TimeZoneNameGetter) { Class.new do
        ...
        class_module.module_eval {
          const_set_lazy(:INSTANCE) { class_self::TimeZoneNameGetter.new }
          ...
          if ((query_id == "GMT"))
            ...
            if (!(aliases).nil?)
              ...
              if (aliases.contains_key(query_id))
                prev_id = query_id
                while (!((query_id = RJava.cast_to_string(aliases.get(query_id)))).nil?)
                  prev_id = query_id
                end
                query_id = prev_id
              end
        ...
        class_module.module_eval {
          typesig { [class_self::TimeZoneNameProvider, class_self::Locale, String, class_self::Map, class_self::JavaSet] }
          ...
          typesig { [class_self::TimeZoneNameProvider, class_self::Locale, String] }
