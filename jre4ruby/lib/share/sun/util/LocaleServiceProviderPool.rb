...
# have any questions.
module Sun::Util
  module LocaleServiceProviderPoolImports #:nodoc:
  ...
  class LocaleServiceProviderPool 
      ...
      const_set_lazy(:AllAvailableLocales) { Class.new do
        ...
        class_module.module_eval {
          when_class_loaded do
            ...
            all = class_self::HashSet.new(Arrays.as_list(LocaleData.get_available_locales))
            ...
            const_set :AllAvailableLocales, all.to_array(Array.typed(class_self::Locale).new(0) { nil })
          end
        }
    ...
    class_module.module_eval {
      ...
      const_set_lazy(:NullProvider) { Class.new(LocaleServiceProvider) do
        ...
        class_module.module_eval {
          const_set_lazy(:INSTANCE) { class_self::NullProvider.new }
