...
# have any questions.
module Sun::Misc
  module InvalidJarIndexExceptionImports #:nodoc:
    class_module.module_eval {
      include ::Java::Lang
      include ::Sun::Misc
      include_const ::Java::Lang, :LinkageError
    }
  end
  ...
  # @author   Zhenghua Li
  # @since   1.3
  class InvalidJarIndexException < InvalidJarIndexExceptionImports.const_get :RuntimeException
    ...
    private
    alias_method :initialize__invalid_jar_index_exception, :initialize
  end
