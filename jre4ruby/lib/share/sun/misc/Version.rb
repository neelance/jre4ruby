      ...
      def jvm_special_version
        synchronized(self) do
          ...
          if ((self.attr_jvm_special_version).nil?)
            self.attr_jvm_special_version = RJava.cast_to_string(get_jvm_special_version)
          end
      ...
      def jdk_special_version
        synchronized(self) do
          ...
          if ((self.attr_jdk_special_version).nil?)
            self.attr_jdk_special_version = RJava.cast_to_string(get_jdk_special_version)
          end
                ...
                begin
                  ...
                  if (cs.length >= 4)
                    ...
                    if (c >= Character.new(?a.ord) && c <= Character.new(?z.ord))
                      self.attr_jvm_special_version = RJava.cast_to_string(Character.to_s(c))
                      next_char += 1
                    end
                  end
