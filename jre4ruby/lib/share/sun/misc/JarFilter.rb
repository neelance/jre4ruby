...
module Sun::Misc
  ...
  class JarFilter 
    include_class_members JarFilterImports
    include FilenameFilter
    
    typesig { [JavaFile, String] }
    def accept(dir, name)
      lower = name.to_lower_case
      return lower.ends_with(".jar") || lower.ends_with(".zip")
    end
    ...
    private
    alias_method :initialize__jar_filter, :initialize
  end
