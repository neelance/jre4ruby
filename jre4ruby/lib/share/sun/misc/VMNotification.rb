...
# have any questions.
module Sun::Misc
  module VMNotificationImports #:nodoc:
  ...
  # @deprecated
  module VMNotification
    include_class_members VMNotificationImports
    ...
    # suspended threads.
    def new_alloc_state(old_state, new_state, threads_suspended)
