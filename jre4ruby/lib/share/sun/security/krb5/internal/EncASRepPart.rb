...
module Sun::Security::Krb5::Internal
  module EncASRepPartImports #:nodoc:
  ...
  class EncASRepPart < EncASRepPartImports.const_get :EncKDCRepPart
    include_class_members EncASRepPartImports
    ...
    typesig { [] }
    def asn1_encode
      return asn1_encode(Krb5::KRB_ENC_AS_REP_PART)
    end
    
    private
    alias_method :initialize__enc_asrep_part, :initialize
  end
