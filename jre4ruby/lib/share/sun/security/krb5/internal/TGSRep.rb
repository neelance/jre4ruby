...
module Sun::Security::Krb5::Internal
  ...
  class TGSRep < TGSRepImports.const_get :KDCRep
    include_class_members TGSRepImports
    ...
    def initialize(new_p_adata, new_crealm, new_cname, new_ticket, new_enc_part)
      super(new_p_adata, new_crealm, new_cname, new_ticket, new_enc_part, Krb5::KRB_TGS_REP)
    end
    ...
    private
    alias_method :initialize__tgsrep, :initialize
  end
