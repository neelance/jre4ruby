...
module Sun::Security::Krb5
  module KrbExceptionImports #:nodoc:
  ...
  class KrbException < KrbExceptionImports.const_get :JavaException
    ...
    def krb_error_message
      strbuf = StringBuffer.new("krb_error " + RJava.cast_to_string(@return_code))
      msg = get_message
      if (!(msg).nil?)
        strbuf.append(" ")
        strbuf.append(msg)
    ...
    typesig { [] }
    def to_s
      return ("KrbException: " + RJava.cast_to_string(get_message))
    end
