...
module Sun::Security::Validator
  module PKIXValidatorImports #:nodoc:
  ...
  class PKIXValidator < PKIXValidatorImports.const_get :Validator
    ...
    def initialize(variant, trusted_certs)
      ...
      begin
        ...
        raise RuntimeException.new("Unexpected error: " + RJava.cast_to_string(e.to_s), e)
      end
    ...
    def do_validate(chain, params)
      begin
        ...
        raise ValidatorException.new("PKIX path validation failed: " + RJava.cast_to_string(e.to_s), e)
      end
    end
    ...
    def do_build(chain, other_certs)
      begin
        ...
        raise ValidatorException.new("PKIX path building failed: " + RJava.cast_to_string(e.to_s), e)
      end
    end
