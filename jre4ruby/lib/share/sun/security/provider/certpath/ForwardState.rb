...
module Sun::Security::Provider::Certpath
  module ForwardStateImports #:nodoc:
  ...
  class ForwardState 
    ...
    def to_s
      ...
      begin
        sb.append("State [")
        sb.append("\n  issuerDN of last cert: " + RJava.cast_to_string(@issuer_dn))
        sb.append("\n  traversedCACerts: " + RJava.cast_to_string(@traversed_cacerts))
        sb.append("\n  init: " + RJava.cast_to_string(String.value_of(@init)))
        sb.append("\n  keyParamsNeeded: " + RJava.cast_to_string(String.value_of(@key_params_needed_flag)))
        sb.append("\n  subjectNamesTraversed: \n" + RJava.cast_to_string(@subject_names_traversed))
        sb.append("]\n")
