...
module Sun::Security::Pkcs12
  module PKCS12KeyStoreImports #:nodoc:
  ...
  class PKCS12KeyStore < PKCS12KeyStoreImports.const_get :KeyStoreSpi
    ...
    def engine_get_key(alias_, password)
      ...
      begin
        ...
        uke = UnrecoverableKeyException.new("Private key not stored as " + "PKCS#8 EncryptedPrivateKeyInfo: " + RJava.cast_to_string(ioe))
        uke.init_cause(ioe)
        raise uke
      end
      begin
        ...
        uke = UnrecoverableKeyException.new("Get Key failed: " + RJava.cast_to_string(e.get_message))
        uke.init_cause(e)
        raise uke
      end
      return key
    ...
    def engine_set_key_entry(alias_, key, password, chain)
      synchronized(self) do
        begin
          ...
          entry.attr_key_id = ("Time " + RJava.cast_to_string((entry.attr_date).get_time)).get_bytes("UTF8")
          # set the alias
          entry.attr_alias = alias_.to_lower_case
          # add the entry
          @entries.put(alias_.to_lower_case, entry)
        rescue JavaException => nsae
          ke = KeyStoreException.new("Key protection " + " algorithm not found: " + RJava.cast_to_string(nsae))
          ke.init_cause(nsae)
          raise ke
        end
      end
    ...
    def engine_set_key_entry(alias_, key, chain)
      synchronized(self) do
        ...
        begin
          ...
          ke = KeyStoreException.new("Private key is not" + " stored as PKCS#8 EncryptedPrivateKeyInfo: " + RJava.cast_to_string(ioe))
          ke.init_cause(ioe)
          raise ke
        end
        entry = KeyEntry.new
    ...
    def get_algorithm_parameters(algorithm)
      ...
      begin
        ...
        ioe = IOException.new("getAlgorithmParameters failed: " + RJava.cast_to_string(e.get_message))
        ioe.init_cause(e)
        raise ioe
      end
      return alg_params
    ...
    def parse_alg_parameters(in_)
      ...
      begin
        ...
        ioe = IOException.new("parseAlgParameters failed: " + RJava.cast_to_string(e.get_message))
        ioe.init_cause(e)
        raise ioe
      end
      return alg_params
    ...
    def get_pbekey(password)
      ...
      begin
        ...
        ioe = IOException.new("getSecretKey failed: " + RJava.cast_to_string(e.get_message))
        ioe.init_cause(e)
        raise ioe
      end
      return skey
    ...
    def encrypt_private_key(data, password)
      ...
      begin
        ...
        uke = UnrecoverableKeyException.new("Encrypt Private Key failed: " + RJava.cast_to_string(e.get_message))
        uke.init_cause(e)
        raise uke
      end
      return key
    ...
    def generate_hash(data)
      ...
      begin
        ...
        ioe = IOException.new("generateHash failed: " + RJava.cast_to_string(e))
        ioe.init_cause(e)
        raise ioe
      end
      return digest
    ...
    def calculate_mac(passwd, data)
      ...
      begin
        ...
        ioe = IOException.new("calculateMac failed: " + RJava.cast_to_string(e))
        ioe.init_cause(e)
        raise ioe
      end
      return m_data
    ...
    def create_safe_content
      ...
      while e.has_more_elements
        ...
        begin
          ...
          raise IOException.new("Private key not stored as " + "PKCS#8 EncryptedPrivateKeyInfo" + RJava.cast_to_string(ioe.get_message))
        end
    ...
    def encrypt_content(data, password)
      ...
      begin
        ...
        ioe = IOException.new("Failed to encrypt" + " safe contents entry: " + RJava.cast_to_string(e))
        ioe.init_cause(e)
        raise ioe
      end
      # create EncryptedContentInfo
      ...
      synchronized(self) do
          ...
          if ((content_type == ContentInfo::DATA_OID))
            ...
            if ((content_type == ContentInfo::ENCRYPTED_DATA_OID))
              ...
              begin
                ...
                ioe = IOException.new("failed to decrypt safe" + " contents entry: " + RJava.cast_to_string(e))
                ioe.init_cause(e)
                raise ioe
              end
            else
        ...
        if (!(password).nil? && s.available > 0)
          ...
          begin
            ...
            ioe = IOException.new("Integrity check failed: " + RJava.cast_to_string(e))
            ioe.init_cause(e)
            raise ioe
          end
        end
    ...
    def load_safe_contents(stream, password)
      ...
      while i < count
        ...
        if (!bag_value.is_context_specific(0))
          raise IOException.new("unsupported PKCS12 bag value type " + RJava.cast_to_string(bag_value.attr_tag))
        end
        ...
        if ((bag_id == self.attr_pkcs8shrouded_key_bag_oid))
          ...
          if ((bag_id == self.attr_cert_bag_oid))
            ...
            if (!cert_values[1].is_context_specific(0))
              raise IOException.new("unsupported PKCS12 cert value type " + RJava.cast_to_string(cert_values[1].attr_tag))
            end
        ...
        if (!(attr_set).nil?)
          ...
          while j < attr_set.attr_length
            ...
            begin
              ...
              raise IOException.new("Attribute " + RJava.cast_to_string(attr_id) + " should have a value " + RJava.cast_to_string(e.get_message))
            end
            if ((attr_id == self.attr_pkcs9friendly_name_oid))
              alias_ = RJava.cast_to_string(val_set[0].get_bmpstring)
            else
        ...
        if (bag_item.is_a?(KeyEntry))
          ...
          @key_list.add(entry)
          if ((alias_).nil?)
            alias_ = RJava.cast_to_string(get_unfriendly_name)
          end
