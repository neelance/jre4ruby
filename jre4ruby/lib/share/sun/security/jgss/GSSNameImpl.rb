...
module Sun::Security::Jgss
  module GSSNameImplImports #:nodoc:
  ...
  class GSSNameImpl 
    ...
    def initialize(gss_manager, mech_element)
      ...
      @app_name_str = RJava.cast_to_string(@printable_name = RJava.cast_to_string(mech_element.to_s))
    ...
    def init(gss_manager, app_name, app_name_type, mech)
      ...
      if ((@printable_name).nil?)
        @printable_name = RJava.cast_to_string(@mech_element.to_s)
    ...
    def ==(other)
      ...
      if (!(other.is_a?(GSSNameImpl)))
        return self.==(@gss_manager.create_name(other.to_s, other.get_string_name_type))
      end
    ...
    def export
      ...
      begin
        ...
        raise GSSExceptionImpl.new(GSSException::FAILURE, "Could not ASN.1 Encode " + RJava.cast_to_string(oid.to_s))
      end
