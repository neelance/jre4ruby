...
module Sun::Security::Jgss
  module GSSExceptionImplImports #:nodoc:
  ...
  class GSSExceptionImpl < GSSExceptionImplImports.const_get :GSSException
    ...
    def initialize(major_code, mech)
      @major_message = nil
      super(major_code)
      @major_message = RJava.cast_to_string(GSSException.instance_method(:get_major_string).bind(self).call) + ": " + RJava.cast_to_string(mech)
    end
    ...
    typesig { [::Java::Int, JavaException] }
    ...
    typesig { [::Java::Int, String, JavaException] }
