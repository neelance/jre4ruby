...
module Sun::Security::Pkcs
  module ContentInfoImports #:nodoc:
  ...
  class ContentInfo 
    ...
    def get_data
      ...
      raise IOException.new("content type is not DATA: " + RJava.cast_to_string(@content_type))
    end
    ...
    def to_s
      out = ""
      out += "Content Info Sequence\n\tContent type: " + RJava.cast_to_string(@content_type) + "\n"
      out += "\tContent: " + RJava.cast_to_string(@content)
      return out
    end
