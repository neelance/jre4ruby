...
module Sun::Security::X509
  module CertificateSubjectUniqueIdentityImports #:nodoc:
  ...
  class CertificateSubjectUniqueIdentity 
    include_class_members CertificateSubjectUniqueIdentityImports
    include CertAttrSet
    
    class_module.module_eval {
      # Identifier for this attribute, to be used with the
      # get, set, delete methods of Certificate, x509 type.
      const_set_lazy(:IDENT) { "x509.info.subjectID" }
      const_attr_reader  :IDENT
      
      # Sub attributes name for this CertAttrSet.
      const_set_lazy(:NAME) { "subjectID" }
    ...
    def encode(out)
      ...
      @id.encode(tmp, DerValue.create_tag(DerValue::TAG_CONTEXT, false, 2))
    ...
    def set(name, obj)
      ...
      if (name.equals_ignore_case(ID))
        ...
        raise IOException.new("Attribute name not recognized by " + "CertAttrSet: CertificateSubjectUniqueIdentity.")
      end
    end
    ...
    private
    alias_method :initialize__certificate_subject_unique_identity, :initialize
  end
