...
module Sun::Security::X509
  module AccessDescriptionImports #:nodoc:
  ...
  class AccessDescription 
    ...
    typesig { [] }
    def to_s
      return ("accessMethod: " + RJava.cast_to_string(@access_method.to_s) + "\n   accessLocation: " + RJava.cast_to_string(@access_location.to_s))
    end
