...
module Sun::Security::X509
  ...
  class OIDMap 
    ...
    class_module.module_eval {
      # "user-friendly" names
      const_set_lazy(:ROOT) { RJava.cast_to_string(X509CertImpl::NAME) + "." + RJava.cast_to_string(X509CertInfo::NAME) + "." + RJava.cast_to_string(X509CertInfo::EXTENSIONS) }
      const_attr_reader  :ROOT
      
      const_set_lazy(:AUTH_KEY_IDENTIFIER) { ROOT + "." + RJava.cast_to_string(AuthorityKeyIdentifierExtension::NAME) }
      const_attr_reader  :AUTH_KEY_IDENTIFIER
      
      const_set_lazy(:SUB_KEY_IDENTIFIER) { ROOT + "." + RJava.cast_to_string(SubjectKeyIdentifierExtension::NAME) }
      const_attr_reader  :SUB_KEY_IDENTIFIER
      
      const_set_lazy(:KEY_USAGE) { ROOT + "." + RJava.cast_to_string(KeyUsageExtension::NAME) }
      const_attr_reader  :KEY_USAGE
      
      const_set_lazy(:PRIVATE_KEY_USAGE) { ROOT + "." + RJava.cast_to_string(PrivateKeyUsageExtension::NAME) }
      const_attr_reader  :PRIVATE_KEY_USAGE
      
      const_set_lazy(:POLICY_MAPPINGS) { ROOT + "." + RJava.cast_to_string(PolicyMappingsExtension::NAME) }
      const_attr_reader  :POLICY_MAPPINGS
      
      const_set_lazy(:SUB_ALT_NAME) { ROOT + "." + RJava.cast_to_string(SubjectAlternativeNameExtension::NAME) }
      const_attr_reader  :SUB_ALT_NAME
      
      const_set_lazy(:ISSUER_ALT_NAME) { ROOT + "." + RJava.cast_to_string(IssuerAlternativeNameExtension::NAME) }
      const_attr_reader  :ISSUER_ALT_NAME
      
      const_set_lazy(:BASIC_CONSTRAINTS) { ROOT + "." + RJava.cast_to_string(BasicConstraintsExtension::NAME) }
      const_attr_reader  :BASIC_CONSTRAINTS
      
      const_set_lazy(:NAME_CONSTRAINTS) { ROOT + "." + RJava.cast_to_string(NameConstraintsExtension::NAME) }
      const_attr_reader  :NAME_CONSTRAINTS
      
      const_set_lazy(:POLICY_CONSTRAINTS) { ROOT + "." + RJava.cast_to_string(PolicyConstraintsExtension::NAME) }
      const_attr_reader  :POLICY_CONSTRAINTS
      
      const_set_lazy(:CRL_NUMBER) { ROOT + "." + RJava.cast_to_string(CRLNumberExtension::NAME) }
      const_attr_reader  :CRL_NUMBER
      
      const_set_lazy(:CRL_REASON) { ROOT + "." + RJava.cast_to_string(CRLReasonCodeExtension::NAME) }
      const_attr_reader  :CRL_REASON
      
      const_set_lazy(:NETSCAPE_CERT) { ROOT + "." + RJava.cast_to_string(NetscapeCertTypeExtension::NAME) }
      const_attr_reader  :NETSCAPE_CERT
      
      const_set_lazy(:CERT_POLICIES) { ROOT + "." + RJava.cast_to_string(CertificatePoliciesExtension::NAME) }
      const_attr_reader  :CERT_POLICIES
      
      const_set_lazy(:EXT_KEY_USAGE) { ROOT + "." + RJava.cast_to_string(ExtendedKeyUsageExtension::NAME) }
      const_attr_reader  :EXT_KEY_USAGE
      
      const_set_lazy(:INHIBIT_ANY_POLICY) { ROOT + "." + RJava.cast_to_string(InhibitAnyPolicyExtension::NAME) }
      const_attr_reader  :INHIBIT_ANY_POLICY
      
      const_set_lazy(:CRL_DIST_POINTS) { ROOT + "." + RJava.cast_to_string(CRLDistributionPointsExtension::NAME) }
      const_attr_reader  :CRL_DIST_POINTS
      
      const_set_lazy(:CERT_ISSUER) { ROOT + "." + RJava.cast_to_string(CertificateIssuerExtension::NAME) }
      const_attr_reader  :CERT_ISSUER
      
      const_set_lazy(:AUTH_INFO_ACCESS) { ROOT + "." + RJava.cast_to_string(AuthorityInfoAccessExtension::NAME) }
      const_attr_reader  :AUTH_INFO_ACCESS
      
      const_set_lazy(:ISSUING_DIST_POINT) { ROOT + "." + RJava.cast_to_string(IssuingDistributionPointExtension::NAME) }
      const_attr_reader  :ISSUING_DIST_POINT
      
      const_set_lazy(:DELTA_CRL_INDICATOR) { ROOT + "." + RJava.cast_to_string(DeltaCRLIndicatorExtension::NAME) }
      const_attr_reader  :DELTA_CRL_INDICATOR
      
      const_set_lazy(:FRESHEST_CRL) { ROOT + "." + RJava.cast_to_string(FreshestCRLExtension::NAME) }
      ...
      const_set_lazy(:OIDInfo) { Class.new do
        ...
        typesig { [String, class_self::ObjectIdentifier, String] }
        ...
        typesig { [String, class_self::ObjectIdentifier, class_self::Class] }
