  ...
  class AlgIdDSA < AlgIdDSAImports.const_get :AlgorithmId
    ...
    def decode_params
      ...
      if (!(self.attr_params.attr_data.available).equal?(0))
        raise IOException.new("AlgIdDSA params, extra=" + RJava.cast_to_string(self.attr_params.attr_data.available))
      end
    end
    ...
    def params_to_string
      if ((self.attr_params).nil?)
        ...
        return "\n    p:\n" + RJava.cast_to_string(Debug.to_hex_string(@p)) + "\n    q:\n" + RJava.cast_to_string(Debug.to_hex_string(@q)) + "\n    g:\n" + RJava.cast_to_string(Debug.to_hex_string(@g)) + "\n"
      end
    end
