...
module Sun::Security::X509
  module CertificateSubjectNameImports #:nodoc:
  ...
  class CertificateSubjectName 
    include_class_members CertificateSubjectNameImports
    include CertAttrSet
    
    class_module.module_eval {
      # Identifier for this attribute, to be used with the
      # get, set, delete methods of Certificate, x509 type.
      const_set_lazy(:IDENT) { "x509.info.subject" }
      const_attr_reader  :IDENT
      
      # Sub attributes name for this CertAttrSet.
      const_set_lazy(:NAME) { "subject" }
    ...
    def set(name, obj)
      ...
      if (name.equals_ignore_case(DN_NAME))
        ...
        raise IOException.new("Attribute name not recognized by " + "CertAttrSet:CertificateSubjectName.")
      end
    end
    ...
    private
    alias_method :initialize__certificate_subject_name, :initialize
  end
