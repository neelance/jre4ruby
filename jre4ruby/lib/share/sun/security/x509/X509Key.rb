    ...
    class_module.module_eval {
      ...
      def parse(in_)
        ...
        begin
          ...
          raise IOException.new("subject key, " + RJava.cast_to_string(e.get_message))
        end
    ...
    class_module.module_eval {
      ...
      def build_x509key(algid, key)
        ...
        begin
          ...
          classname = RJava.cast_to_string(sun_provider.get_property("PublicKey.X.509." + RJava.cast_to_string(algid.get_name)))
          if ((classname).nil?)
            raise InstantiationException.new
          end
          key_class = nil
