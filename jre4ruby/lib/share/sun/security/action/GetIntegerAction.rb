...
module Sun::Security::Action
  module GetIntegerActionImports #:nodoc:
  ...
  class GetIntegerAction 
    include_class_members GetIntegerActionImports
    ...
    def run
      value = JavaInteger.get_integer(@the_prop)
    ...
    private
    alias_method :initialize__get_integer_action, :initialize
  end
