...
module Sun::Security::Action
  module GetBooleanActionImports #:nodoc:
  ...
  class GetBooleanAction 
    include_class_members GetBooleanActionImports
    ...
    def run
      return Boolean.get_boolean(@the_prop)
    end
    
    private
    alias_method :initialize__get_boolean_action, :initialize
  end
