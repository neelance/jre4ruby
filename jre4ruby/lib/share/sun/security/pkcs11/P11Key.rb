  ...
  class P11Key 
    ...
    class_module.module_eval {
      ...
      const_set_lazy(:P11PrivateKey) { Class.new(P11Key) do
        ...
        typesig { [class_self::Session, ::Java::Long, String, ::Java::Int, Array.typed(class_self::CK_ATTRIBUTE)] }
      ...
      const_set_lazy(:P11TlsMasterSecretKey) { Class.new(P11SecretKey) do
        ...
        typesig { [class_self::Session, ::Java::Long, String, ::Java::Int, Array.typed(class_self::CK_ATTRIBUTE), ::Java::Int, ::Java::Int] }
