...
module Sun::Net::Httpserver
  module HttpExchangeImplImports #:nodoc:
  ...
  class HttpExchangeImpl < HttpExchangeImplImports.const_get :HttpExchange
    include_class_members HttpExchangeImplImports
    ...
    private
    alias_method :initialize__http_exchange_impl, :initialize
  end
