...
module Java::Security::Cert
  ...
  class CertStore 
    ...
    class_module.module_eval {
      ...
      # certstore.type=LDAP
      # </pre>
      const_set_lazy(:CERTSTORE_TYPE) { "certstore.type" }
      const_attr_reader  :CERTSTORE_TYPE
    }
    
    attr_accessor :store_spi
    alias_method :attr_store_spi, :store_spi
    undef_method :store_spi
    alias_method :attr_store_spi=, :store_spi=
    undef_method :store_spi=
    ...
    def initialize(store_spi, provider, type, params)
      @store_spi = nil
      @provider = nil
      @type = nil
      @params = nil
    ...
    class_module.module_eval {
      ...
      def get_instance(type, params)
        begin
          instance = GetInstance.get_instance("CertStore", CertStoreSpi.class, type, params)
          return CertStore.new(instance.attr_impl, instance.attr_provider, type, params)
      ...
      def handle_exception(e)
        cause = e.get_cause
        if (cause.is_a?(InvalidAlgorithmParameterException))
          raise cause
        end
        raise e
      end
      ...
      def get_instance(type, params, provider)
        begin
          instance = GetInstance.get_instance("CertStore", CertStoreSpi.class, type, params, provider)
          return CertStore.new(instance.attr_impl, instance.attr_provider, type, params)
        rescue NoSuchAlgorithmException => e
          return handle_exception(e)
        end
    ...
    def get_cert_store_parameters
      return ((@params).nil? ? nil : @params.clone)
    end
    ...
    class_module.module_eval {
      ...
      def get_default_type
        cstype = nil
        cstype = (AccessController.do_privileged(Class.new(PrivilegedAction.class == Class ? PrivilegedAction : Object) do
          extend LocalClass
    ...
    private
    alias_method :initialize__cert_store, :initialize
  end
