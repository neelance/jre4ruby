...
module Java::Security::Cert
  module PolicyQualifierInfoImports
  ...
  class PolicyQualifierInfo 
    ...
    def initialize(encoded)
      ...
      @m_id = ((val.attr_data.get_der_value).get_oid.to_s).to_s
    ...
    def to_s
      ...
      sb.append("  qualifier: " + (((@m_data).nil? ? "null" : enc.encode_buffer(@m_data))).to_s + "\n")
      sb.append("]")
      @pqi_string = (sb.to_s).to_s
      return @pqi_string
    end
