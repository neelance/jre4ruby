...
module Java::Security
  module UnresolvedPermissionCollectionImports
  ...
  class UnresolvedPermissionCollection < UnresolvedPermissionCollectionImports.const_get :PermissionCollection
    ...
    class_module.module_eval {
      ...
      # of permissions
      const_set_lazy(:SerialPersistentFields) { Array.typed(ObjectStreamField).new([ObjectStreamField.new("permissions", Hashtable.class), ]) }
