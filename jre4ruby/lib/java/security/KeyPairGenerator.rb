    ...
    class_module.module_eval {
      ...
      def get_instance(algorithm)
        ...
        begin
          s = t.next
          begin
            instance = GetInstance.get_instance(s, KeyPairGeneratorSpi.class)
            if (instance.attr_impl.is_a?(KeyPairGenerator))
      ...
      def get_instance(algorithm, provider)
        instance = GetInstance.get_instance("KeyPairGenerator", KeyPairGeneratorSpi.class, algorithm, provider)
        return get_instance(instance, algorithm)
      end
                  ...
                  if ((@init_type).equal?(self.class::I_SIZE))
                    ...
                    if ((@init_type).equal?(self.class::I_PARAMS))
                      ...
                      if (!(@init_type).equal?(self.class::I_NONE))
                        raise AssertionError.new("KeyPairGenerator initType: " + (@init_type).to_s)
                      end
                    end
                  end
                end
