...
module Java::Security
  ...
  class Permissions < PermissionsImports.const_get :PermissionCollection
    ...
    def get_unresolved_permissions(p)
      ...
      uc = @perms_map.get(UnresolvedPermission.class)
    ...
    class_module.module_eval {
      ...
      const_set_lazy(:SerialPersistentFields) { Array.typed(ObjectStreamField).new([ObjectStreamField.new("perms", Hashtable.class), ObjectStreamField.new("allPermission", PermissionCollection.class), ]) }
  ...
  class PermissionsHash < PermissionsImports.const_get :PermissionCollection
    ...
    class_module.module_eval {
      ...
      const_set_lazy(:SerialPersistentFields) { Array.typed(ObjectStreamField).new([ObjectStreamField.new("perms", Hashtable.class), ]) }
      const_attr_reader  :SerialPersistentFields
    }
