...
module Java::Nio::Channels
  ...
  class SelectionKey 
    ...
    class_module.module_eval {
      ...
      # selected-key&nbsp;set.  </p>
      const_set_lazy(:OP_ACCEPT) { 1 << 4 }
      const_attr_reader  :OP_ACCEPT
    }
    ...
    alias_method :attr_attachment, :attachment
    undef_method :attachment
    alias_method :attr_attachment=, :attachment=
    undef_method :attachment=
    
    class_module.module_eval {
      const_set_lazy(:AttachmentUpdater) { AtomicReferenceFieldUpdater.new_updater(SelectionKey.class, Object.class, "attachment") }
      const_attr_reader  :AttachmentUpdater
    }
    ...
    private
    alias_method :initialize__selection_key, :initialize
  end
