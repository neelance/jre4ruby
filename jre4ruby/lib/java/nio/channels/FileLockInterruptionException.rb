...
module Java::Nio::Channels
  ...
  class FileLockInterruptionException < Java::Io::IOException
    include_class_members FileLockInterruptionExceptionImports
    
    class_module.module_eval {
      const_set_lazy(:SerialVersionUID) { 7104080643653532383 }
    ...
    private
    alias_method :initialize__file_lock_interruption_exception, :initialize
  end
