...
module Java::Lang::Instrument
  ...
  module Instrumentation
    ...
    # @since 1.6
    def add_transformer(transformer, can_retransform)
    ...
    # false if not.
    # @see #redefineClasses
    def is_redefine_classes_supported
      raise NotImplementedError
    end
    ...
    # @see #isRedefineClassesSupported
    # @since 1.6
    def is_modifiable_class(the_class)
      raise NotImplementedError
    end
    ...
    def get_object_size(object_to_size)
      raise NotImplementedError
    end
    ...
    # 
    # @since 1.6
    def append_to_bootstrap_class_loader_search(jarfile)
      raise NotImplementedError
    end
    ...
    # @see     java.util.jar.JarFile
    # @since 1.6
    def append_to_system_class_loader_search(jarfile)
      raise NotImplementedError
    end
    ...
    # @since 1.6
    def is_native_method_prefix_supported
      raise NotImplementedError
    end
