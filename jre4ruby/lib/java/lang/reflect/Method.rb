  ...
  class Method < MethodImports.const_get :AccessibleObject
    ...
    def to_s
      begin
        ...
        sb.append((Field.get_type_name(get_return_type)).to_s + " ")
        sb.append((Field.get_type_name(get_declaring_class)).to_s + ".")
        sb.append((get_name).to_s + "(")
    ...
    def to_generic_string
      begin
        ...
        sb.append((((gen_ret_type.is_a?(Class)) ? Field.get_type_name(gen_ret_type) : gen_ret_type.to_s)).to_s + " ")
        sb.append((Field.get_type_name(get_declaring_class)).to_s + ".")
        sb.append((get_name).to_s + "(")
    ...
    def get_default_value
      ...
      if (result.is_a?(Sun::Reflect::Annotation::ExceptionProxy))
        raise AnnotationFormatError.new("Invalid default: " + (self).to_s)
      end
      return result
    end
