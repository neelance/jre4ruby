  ...
  class AbstractQueuedLongSynchronizer < AbstractQueuedLongSynchronizerImports.const_get :AbstractOwnableSynchronizer
    ...
    class_module.module_eval {
      ...
      when_class_loaded do
        begin
          const_set :StateOffset, UnsafeInstance.object_field_offset(AbstractQueuedLongSynchronizer.class.get_declared_field("state"))
          const_set :HeadOffset, UnsafeInstance.object_field_offset(AbstractQueuedLongSynchronizer.class.get_declared_field("head"))
          const_set :TailOffset, UnsafeInstance.object_field_offset(AbstractQueuedLongSynchronizer.class.get_declared_field("tail"))
