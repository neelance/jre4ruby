...
module Java::Util::Concurrent
  ...
  class ConcurrentSkipListMap < ConcurrentSkipListMapImports.const_get :AbstractMap
    ...
    class_module.module_eval {
      # Updater for casHead
      const_set_lazy(:HeadUpdater) { AtomicReferenceFieldUpdater.new_updater(ConcurrentSkipListMap.class, HeadIndex.class, "head") }
    ...
    class_module.module_eval {
      ...
      const_set_lazy(:Node) { Class.new do
        ...
        class_module.module_eval {
          ...
          const_set_lazy(:ValueUpdater) { AtomicReferenceFieldUpdater.new_updater(Node.class, Object.class, "value") }
      ...
      const_set_lazy(:Index) { Class.new do
        ...
        class_module.module_eval {
          ...
          const_set_lazy(:RightUpdater) { AtomicReferenceFieldUpdater.new_updater(Index.class, Index.class, "right") }
