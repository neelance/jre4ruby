...
module Java::Util::Concurrent
  module ConcurrentLinkedQueueImports
  ...
  class ConcurrentLinkedQueue < ConcurrentLinkedQueueImports.const_get :AbstractQueue
    ...
    class_module.module_eval {
      ...
      const_set_lazy(:Node) { Class.new do
        ...
        class_module.module_eval {
          const_set_lazy(:NextUpdater) { AtomicReferenceFieldUpdater.new_updater(Node.class, Node.class, "next") }
          const_attr_reader  :NextUpdater
          
          const_set_lazy(:ItemUpdater) { AtomicReferenceFieldUpdater.new_updater(Node.class, Object.class, "item") }
      ...
      const_set_lazy(:TailUpdater) { AtomicReferenceFieldUpdater.new_updater(ConcurrentLinkedQueue.class, Node.class, "tail") }
      const_attr_reader  :TailUpdater
      
      const_set_lazy(:HeadUpdater) { AtomicReferenceFieldUpdater.new_updater(ConcurrentLinkedQueue.class, Node.class, "head") }
