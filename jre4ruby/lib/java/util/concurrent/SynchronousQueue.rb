      ...
      const_set_lazy(:TransferStack) { Class.new(Transferer) do
        ...
        class_module.module_eval {
          ...
          const_set_lazy(:SNode) { Class.new do
            ...
            class_module.module_eval {
              const_set_lazy(:NextUpdater) { AtomicReferenceFieldUpdater.new_updater(SNode.class, SNode.class, "next") }
            ...
            class_module.module_eval {
              const_set_lazy(:MatchUpdater) { AtomicReferenceFieldUpdater.new_updater(SNode.class, SNode.class, "match") }
        ...
        class_module.module_eval {
          const_set_lazy(:HeadUpdater) { AtomicReferenceFieldUpdater.new_updater(TransferStack.class, SNode.class, "head") }
      ...
      const_set_lazy(:TransferQueue) { Class.new(Transferer) do
        ...
        class_module.module_eval {
          ...
          const_set_lazy(:QNode) { Class.new do
            ...
            class_module.module_eval {
              const_set_lazy(:NextUpdater) { AtomicReferenceFieldUpdater.new_updater(QNode.class, QNode.class, "next") }
              const_attr_reader  :NextUpdater
            }
            ...
            class_module.module_eval {
              const_set_lazy(:ItemUpdater) { AtomicReferenceFieldUpdater.new_updater(QNode.class, Object.class, "item") }
        ...
        class_module.module_eval {
          const_set_lazy(:HeadUpdater) { AtomicReferenceFieldUpdater.new_updater(TransferQueue.class, QNode.class, "head") }
          const_attr_reader  :HeadUpdater
        }
        ...
        class_module.module_eval {
          const_set_lazy(:TailUpdater) { AtomicReferenceFieldUpdater.new_updater(TransferQueue.class, QNode.class, "tail") }
        ...
        class_module.module_eval {
          const_set_lazy(:CleanMeUpdater) { AtomicReferenceFieldUpdater.new_updater(TransferQueue.class, QNode.class, "cleanMe") }
