...
module Java::Io
  ...
  class ObjectStreamField 
    ...
    def initialize(name, type, unshared)
      ...
      @type = type
      @unshared = unshared
      @signature = (ObjectStreamClass.get_class_signature(type).intern).to_s
      @field = nil
    end
    ...
    def initialize(field, unshared, show_type)
      ...
      @type = (show_type || ftype.is_primitive) ? ftype : Object.class
      @signature = (ObjectStreamClass.get_class_signature(ftype).intern).to_s
    end
