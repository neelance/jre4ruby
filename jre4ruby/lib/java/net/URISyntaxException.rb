...
# have any questions.
module Java::Net
  module URISyntaxExceptionImports
  ...
  # @see URI
  # @since 1.4
  class URISyntaxException < URISyntaxExceptionImports.const_get :Exception
    ...
    def get_reason
      return Exception.instance_method(:get_message).bind(self).call
    end
