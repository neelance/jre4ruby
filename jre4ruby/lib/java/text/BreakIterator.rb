  ...
  class BreakIterator 
    ...
    class_module.module_eval {
      ...
      def create_break_instance(locale, type, data_name, dictionary_name)
        ...
        pool = LocaleServiceProviderPool.get_pool(BreakIteratorProvider.class)
        ...
        begin
          if ((class_names[type] == "RuleBasedBreakIterator"))
            ...
            if ((class_names[type] == "DictionaryBasedBreakIterator"))
              ...
              raise IllegalArgumentException.new("Invalid break iterator class \"" + (class_names[type]).to_s + "\"")
            end
          end
        rescue Exception => e
