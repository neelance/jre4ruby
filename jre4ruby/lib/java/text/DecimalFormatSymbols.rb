...
module Java::Text
  module DecimalFormatSymbolsImports
  ...
  class DecimalFormatSymbols 
    ...
    class_module.module_eval {
      ...
      def get_available_locales
        pool = LocaleServiceProviderPool.get_pool(DecimalFormatSymbolsProvider.class)
    ...
    def set_international_currency_symbol(currency_code)
      ...
      if (!(currency_code).nil?)
        begin
          ...
          @currency_symbol = (@currency.get_symbol).to_s
    ...
    def set_currency(currency)
      ...
      @currency = currency
      @intl_currency_symbol = (currency.get_currency_code).to_s
      @currency_symbol = (currency.get_symbol(@locale)).to_s
    end
    ...
    def initialize_(locale)
      ...
      @exponential_separator = (number_elements[7]).to_s # string representation new since 1.6
      @per_mill = number_elements[8].char_at(0)
      @infinity = (number_elements[9]).to_s
      @na_n = (number_elements[10]).to_s
    ...
    def read_object(stream)
      ...
      if (@serial_version_on_stream < 3)
        ...
        @exponential_separator = (Character.to_s(@exponential)).to_s
      end
      @serial_version_on_stream = CurrentSerialVersion
    ...
    class_module.module_eval {
      ...
      const_set_lazy(:DecimalFormatSymbolsGetter) { Class.new do
        ...
        class_module.module_eval {
          const_set_lazy(:INSTANCE) { DecimalFormatSymbolsGetter.new }
          const_attr_reader  :INSTANCE
        }
        
        typesig { [DecimalFormatSymbolsProvider, Locale, String, Object] }
