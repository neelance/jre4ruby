  ...
  class Collator 
    ...
    class_module.module_eval {
      ...
      def get_instance(desired_locale)
        synchronized(self) do
          ...
          pool = LocaleServiceProviderPool.get_pool(CollatorProvider.class)
          ...
          begin
            ...
            col_string = (resource.get_string("Rule")).to_s
          rescue MissingResourceException => e
            # Use default values
          end
          begin
            result = RuleBasedCollator.new((CollationRules::DEFAULTRULES).to_s + col_string, CANONICAL_DECOMPOSITION)
    ...
    class_module.module_eval {
      ...
      const_set_lazy(:CollatorGetter) { Class.new do
        ...
        class_module.module_eval {
          const_set_lazy(:INSTANCE) { CollatorGetter.new }
          const_attr_reader  :INSTANCE
        }
        
        typesig { [CollatorProvider, Locale, String, Object] }
