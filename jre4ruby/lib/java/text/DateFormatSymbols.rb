...
module Java::Text
  module DateFormatSymbolsImports
  ...
  class DateFormatSymbols 
    ...
    class_module.module_eval {
      ...
      def get_available_locales
        pool = LocaleServiceProviderPool.get_pool(DateFormatSymbolsProvider.class)
    ...
    def set_local_pattern_chars(new_local_pattern_chars)
      @local_pattern_chars = (String.new(new_local_pattern_chars)).to_s
    end
    ...
    class_module.module_eval {
      ...
      const_set_lazy(:DateFormatSymbolsGetter) { Class.new do
        ...
        class_module.module_eval {
          const_set_lazy(:INSTANCE) { DateFormatSymbolsGetter.new }
          const_attr_reader  :INSTANCE
        }
        
        typesig { [DateFormatSymbolsProvider, Locale, String, Object] }
